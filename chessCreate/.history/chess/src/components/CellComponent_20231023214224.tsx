...
const CellComponent:FC<CellProps> = ({cell, click, selected, clicked}) => {
    return (
        <div onClick={() => click(cell)} style={{backgroundColor: cell.available && cell.figure?.figureName !== FigureName.KING && cell.figure ? 'green' : ''}} className={['cell', cell.color, selected && cell.figure ? 'selected' : ''].join(' ')}>
            ...
            {cell.Pawn1 && clicked?.figure?.color === Color.WHITE ? cell.figure?.color !== Color.WHITE && <div className='cell__block_white'></div> : cell.figure?.color !== Color.BLACK && <div className='cell__block_black'></div>}
            {cell.Pawn2 && clicked?.figure?.color === Color.WHITE ? cell.figure?.color !== Color.WHITE && <div className='cell__block_white'></div> : cell.figure?.color !== Color.BLACK && <div className='cell__block_black'></div>}
            {cell.Pawn3 && clicked?.figure?.color === Color.WHITE ? cell.figure?.color !== Color.WHITE && <div className='cell__block_white'></div> : cell.figure?.color !== Color.BLACK && <div className='cell__block_black'></div>}
            {cell.Pawn4 && clicked?.figure?.color === Color.WHITE ? cell.figure?.color !== Color.WHITE && <div className='cell__block_white'></div> : cell.figure?.color !== Color.BLACK && <div className='cell__block_black'></div>}
            {cell.Pawn5 && clicked?.figure?.color === Color.WHITE ? cell.figure?.color !== Color.WHITE && <div className='cell__block_white'></div> : cell.figure?.color !== Color.BLACK && <div className='cell__block_black'></div>}
            {cell.Pawn6 && clicked?.figure?.color === Color.WHITE ? cell.figure?.color !== Color.WHITE && <div className='cell__block_white'></div> : cell.figure?.color !== Color.BLACK && <div className='cell__block_black'></div>}
            {cell.Pawn7 && clicked?.figure?.color === Color.WHITE ? cell.figure?.color !== Color.WHITE && <div className='cell__block_white'></div> : cell.figure?.color !== Color.BLACK && <div className='cell__block_black'></div>}
            {cell.Pawn8 && clicked?.figure?.color === Color.WHITE ? cell.figure?.color !== Color.WHITE && <div className='cell__block_white'></div> : cell.figure?.color !== Color.BLACK && <div className='cell__block_black'></div>}
        </div>
    )
} 
