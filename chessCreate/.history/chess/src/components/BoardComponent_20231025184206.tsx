...
const BoardComponent: FC<BoardProps> = ({
  ...
  const click = (cell: Cell) => {
    if (clicked && cell !== clicked && clicked.figure?.canMove(cell)) {
      if(clicked.figure?.color === Color.WHITE && clicked.figure?.figureName === FigureName.QUEEN && cell.figure?.color === Color.BLACK && cell.figure?.figureName === FigureName.PAWN){                
        console.log('We inside!');   
        cell.blackPawn[cell.figure.uniqValue!] = false  
      }
