            ...
            setTimeout(() => {
                if(cell.figure?.color === Color.WHITE || cell.figure?.color === Color.BLACK ){
                    if(cell.figure.figureName === FigureName.QUEEN){
                        if(cell.tryToKillKingDiagonal(cell, cell.figure?.color === Color.BLACK ? whiteKing ) || cell.tryToKillKingHorizontal(cell, blackKing) || cell.tryToKillKingVertical(cell, blackKing)){
                            alertBlackKing()
                        }
                    }
