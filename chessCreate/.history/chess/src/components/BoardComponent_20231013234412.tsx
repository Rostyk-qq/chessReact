...
const BoardComponent:FC<BoardProps> = ({board, setBoard, change, currentColor}) => {
    ...
    return (
        <div className='board'>
            {whitePawn && <ChangeFigures setPawn={setBlackPawn} array={board.arrayWhiteForChange} pawn={whitePawn} />}
            {blackPawn && <ChangeFigures array={board.arrayBlackForChange} pawn={blackPawn} />}
