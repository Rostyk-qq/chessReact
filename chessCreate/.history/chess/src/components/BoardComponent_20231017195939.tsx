...
interface BoardProps {
    ...
    change: (color: Player | null) => void
    currentColor: Player | null
    whiteColor: Player | null
    blackColor: Player | null
}
...
const BoardComponent:FC<BoardProps> = ({board, setBoard, change, currentColor, whiteColor, blackColor}) => {
