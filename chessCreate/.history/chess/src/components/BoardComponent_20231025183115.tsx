...
const BoardComponent: FC<BoardProps> = ({
  ...
  const click = (cell: Cell) => {
    if (clicked && cell !== clicked && clicked.figure?.canMove(cell)) {
      ...
      if((this.cell.figure?.color === Color.WHITE && this.cell.figure.figureName === FigureName.PAWN) && (target.figure?.color === Color.BLACK && target.figure.figureName === FigureName.PAWN)){                
