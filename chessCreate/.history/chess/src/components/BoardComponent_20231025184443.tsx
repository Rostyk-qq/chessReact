...
const BoardComponent: FC<BoardProps> = ({
  ...
  const click = (cell: Cell) => {
    if (clicked && cell !== clicked && clicked.figure?.canMove(cell)) {
      if(clicked.figure?.color === Color.WHITE && clicked.figure?.figureName === FigureName.PAWN && cell.figure?.color === Color.BLACK && cell.figure?.figureName === FigureName.QUEEN){                
        console.log('We inside!');   
        clicked.blackPawn[clicked.figure.uniqValue!] = false  
      }
