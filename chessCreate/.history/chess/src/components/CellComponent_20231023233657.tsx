...
const CellComponent:FC<CellProps> = ({cell, click, selected}) => {
    return (
        <div onClick={() => click(cell)} style={{backgroundColor: cell.available && cell.figure?.figureName !== FigureName.KING && cell.figure ? 'green' : ''}} className={['cell', cell.color, selected && cell.figure ? 'selected' : ''].join(' ')}>
            ...
            {cell.whitePawn[0] && cell.figure?.color !== Color.WHITE && <div className='cell__block_white'></div>}
            {cell.whitePawn[21] && cell.figure?.color !== Color.WHITE && <div className='cell__block_white'></div>}
            ...
            {cell.blackPawn[0] && cell.figure?.color !== Color.BLACK && <div className='cell__block_black'></div>}
            ...
            {cell.blackPawn[4] && cell.figure?.color !== Color.BLACK && <div className='cell__block_black'></div>}
