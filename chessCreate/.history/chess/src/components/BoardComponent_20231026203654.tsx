  ...
  const click = (cell: Cell) => {
    if (clicked && cell !== clicked && clicked.figure?.canMove(cell)) {
      ...
      && cell.figure?.color === Color.WHITE){
            clicked.board.arrayWhiteFiguresKingMovement.push(cell.figure)
      }
      if((clicked.figure?.figureName === FigureName.QUEEN 
      || cecellll.figure?.figureName === FigureName.BISHOP
      || cell.figure?.figureName === FigureName.ROOK) 
      && cell.figure?.color === Color.BLACK){
            clicked.board.arrayBlackFiguresKingMovement.push(cell.figure)
      }   
