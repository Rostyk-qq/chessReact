        ...
        if(clicked && cell !== clicked && clicked.figure?.canMove(cell)){
            ...
            setTimeout(() => {
                if(cell.figure?.color === Color.WHITE){
                    ...
                    if(cell.figure?.figureName === FigureName.QUEEN){
                        if(cell.tryToKillKingDiagonal(cell, whiteKing) || cell.tryToKillKingHorizontal(cell, whiteKing) || cell.tryToKillKingVertical(cell, whiteKing)){
                            alertWhiteKing()
                        }
                    }
                    if(cell.figure?.figureName === FigureName.ROOK ){
                        if(cell.tryToKillKingHorizontal(cell, whiteKing) || cell.tryToKillKingVertical(cell, whiteKing)){
                            alertWhiteKing()
                        }
                    }
                    if(cell.figure?.figureName === FigureName.BISHOP){
