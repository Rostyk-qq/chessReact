...
const BoardComponent: FC<BoardProps> = ({
  ...
  const click = (cell: Cell) => {
    if (clicked && cell !== clicked && clicked.figure?.canMove(cell)) {
      ...
      if((clicked.figure?.color === Color.WHITE && this.cell.figure.figureName === FigureName.PAWN) && (target.figure?.color === Color.BLACK && target.figure.figureName === FigureName.PAWN)){                
