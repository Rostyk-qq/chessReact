...
const BoardComponent:FC<BoardProps> = ({board, setBoard, change, currentColor}) => {
    ...
    return (
        <div className='board'>
            {whitePawn && <ChangeFigures board= setPawn={setWhitePawn} array={board.arrayWhiteForChange} pawn={whitePawn} />}
            {blackPawn && <ChangeFigures setPawn={setBlackKing} array={board.arrayBlackForChange} pawn={blackPawn} />}
