...
export class Cell{
        ...
        moveFigure(target: Cell){
            ...
            DiagonalKill(start: Cell, end: Cell, king: XY){
                const directionX = start.x < end.x ? 1 : -1;
                const directionY = start.y < end.y ? 1 : -1;
                ...
                for(let i = 1; i <= dx; i++){
                    ...
                    this.board.getCell(start.y + (i * directionY), start.x  + (i * directionX)).x < end.x &&
                    king.x < this.board.getCell(start.y + (i * directionY), start.x  + (i * directionX)).x &&
                    
                    this.board.getCell(start.y + (i * directionY), start.x  + (i * directionX)).y < end.y &&
                    king.y < this.board.getCell(start.y + (i * directionY), start.x  + (i * directionX)).y > king.y &&
