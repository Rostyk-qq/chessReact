...
export class Cell{
        ...
        blockFigureMovementDiagonal(figure: Cell, king: XY){
            ...
            if(dx !== dy){
                console.log(this.arrayBlockCell.length);
                
                if(this.arrayBlockCell.length){
                    return {cell: this.arrayBlockCell[0], bool: false}
                }else{
                ...
                if(kingCell && arrayFigures.length === 2 && dx === dy){
                    this.arrayBlockCell.push(newArray[0])
