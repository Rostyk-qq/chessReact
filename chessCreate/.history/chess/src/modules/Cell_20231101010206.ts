...
export class Cell{
        ...
        blockFigureMovementDiagonal(figure: Cell, king: XY){
            ...
            const arrayFiguresRemoveBlock: Array<Cell> = [];
            ...
            if(dx === dy){
                ...
                arrayFiguresRemoveBlock.push(newArray[0])
                ...
                if(arrayFigures.length !== 2){
                    console.log(arrayFiguresRemoveBlock[0]);
                    return {cell: arrayFiguresRemoveBlock[0], bool: false}
                }
            } 
        }
