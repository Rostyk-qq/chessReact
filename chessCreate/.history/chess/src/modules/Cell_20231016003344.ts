...
import { Rook } from "./figures/Rook"
    ...
    export class Cell{
        ...
        whiteKingKill(cell: Cell, kingParams: XY, blackKing: Cell | null, dxDy: XY | null){
            if(cell.figure?.figureName === FigureName.QUEEN){
                if(this.tryToKillKingHorizontal(cell, kingParams) || this.tryToKillKingDiagonal(cell, kingParams, blackKing, dxDy) || this.tryToKillKingVertical(cell, kingParams, blackKing, dxDy)){
                    return true;
                }
            }
            if(cell.figure?.figureName === FigureName.BISHOP){
