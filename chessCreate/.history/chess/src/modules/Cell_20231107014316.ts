        ...
        moveFigure(target: Cell){
            ...
            DiagonalKill(start: Cell, end: Cell){
                ...
                for(let i = 1; i <= dx; i++){
                    ...
                    (Math.abs(this.board.getCell(start.y + (i * directionY), start.x  + (i * directionX)).y - end.y) === start.y + dy && Math.abs(this.board.getCell(start.y + (i * directionY), start.x  + (i * directionX)).x - end.x) === start.x + directionX)){
                        return true 
                    }
                }
                return false    
