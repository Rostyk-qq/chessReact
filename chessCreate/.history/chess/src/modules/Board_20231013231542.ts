...
export class Board {
    ...
    setBishop(){
        ...
        this.arrayWhiteForChange.push(new Rook(Color.WHITE, this.getCell(7, 2)))
        this.arrayBlackForChange.push(new Rook(Color.BLACK, this.getCell(0, 2)))
    }
    setKnight(){
        ...
        this.arrayWhiteForChange.push(new Rook(Color.WHITE, this.getCell(7, 1)))
        this.arrayBlackForChange.push(new Rook(Color.BLACK, this.getCell(0, 1)))
    }
    setRook(){
