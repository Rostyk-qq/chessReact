...
export class Cell{
        ...
        moveFigure(target: Cell){
            ...
            blockFigureMovementDiagonal(figure: Cell, king: XY){                            
                ...
                const kingFigure = arrayFigures.find(el => el === this.board.getCell(king.y, king.x))

                if(arrayFigures.length === 3 && dx === dy && kingFigure!.figure?.color === Color.BLACK ?
                    ((figure.figure?.figureName === FigureName.QUEEN && figure.figure?.color === Color.WHITE) || 
                    (figure.figure?.figureName === FigureName.ROOK && figure.figure?.color === Color.WHITE) || 
                    (figure.figure?.figureName === FigureName.BISHOP && figure.figure?.color === Color.WHITE)) 
                    :   
                    ((figure.figure?.figureName === FigureName.QUEEN && figure.figure?.color === Color.BLACK) || 
                    (figure.figure?.figureName === FigureName.ROOK && figure.figure?.color === Color.BLACK) || 
                    (figure.figure?.figureName === FigureName.BISHOP && figure.figure?.color === Color.BLACK))){
            ...
            blockFigureMovementVertical(figure: Cell, king: XY){
                ...
                const kingFigure = arrayCell.find(el => el === this.board.getCell(king.y, king.x))

                if(arrayCell.length === 3 && figure.x === king.x && kingFigure!.figure?.color === Color.BLACK ?
                    ((figure.figure?.figureName === FigureName.QUEEN && figure.figure?.color === Color.WHITE) || 
                    (figure.figure?.figureName === FigureName.ROOK && figure.figure?.color === Color.WHITE) || 
                    (figure.figure?.figureName === FigureName.BISHOP && figure.figure?.color === Color.WHITE)) 
                    :   
                    ...
                    arrayCell = arrayCell.filter(el => el !== arrayCell[1])
                    return {cell: arrayCell[0], bool: false}
                } 
            }
            ...
            blockFigureMovementHorizontal(figure: Cell, king: XY){
                ...
                if(arrayCell.length === 3 && figure.y === king.y && kingFigure!.figure?.color === Color.BLACK ?
                    ((figure.figure?.figureName === FigureName.QUEEN && figure.figure?.color === Color.WHITE) || 
                    (figure.figure?.figureName === FigureName.ROOK && figure.figure?.color === Color.WHITE) || 
                    (figure.figure?.figureName === FigureName.BISHOP && figure.figure?.color === Color.WHITE)) 
                    :   
