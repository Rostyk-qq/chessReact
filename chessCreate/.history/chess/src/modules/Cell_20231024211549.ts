...
export class Cell{
        ...
        setDeletedFigures(target: Figure){
            ...
            if(target.figureName === FigureName.QUEEN){
                if(this.figure?.color === Color.WHITE){
                    if(this.moveDiagonalKingDisabledWhite(target.cell)){
                        this.whiteQueen = false
                    }
                    if(this.moveHorizontalKingDisabledWhite(target.cell)){
                        this.whiteQueen = false
                    }
                    if(this.moveVerticalKingDisabledWhite(target.cell)){  
                        this.whiteQueen = false
                    }
                }
        
                if(this.figure?.color === Color.BLACK){ 
                    if(this.moveDiagonalKingDisabledBlack(target.cell)){
                        this.blackQueen = false
                    }
                    if(this.moveHorizontalKingDisabledBlack(target.cell)){
                        this.blackQueen = false
                    }
                    if(this.moveVerticalKingDisabledBlack(target.cell)){  
                        this.blackQueen = false
                    }
                }
            }
