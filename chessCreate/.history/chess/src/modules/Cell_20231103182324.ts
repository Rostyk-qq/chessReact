...
export class Cell{
        ...
        blockFigureMovementDiagonal(figure: Cell, king: XY){            
            ...
            blockFigureMovementHorizontal(figure: Cell, king: XY){
                ...
                if(arrayCell.length === 3 && figure.y === king.y && this.board.deletedWhiteFigures.find(el => el.figureName === figureMain.figure.figureName && el.color === figureMain.figure.color)){
                    console.log(arrayCell, this.cellHorizontal);
