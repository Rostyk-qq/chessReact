        ...
        for (let i = 0; i < this.cells.length; i++) {
            ...
            for (let j = 0; j < row.length; j++) {
                ...
                if(!!target?.figure?.canBlock(cell) && target.figure.color === Color.WHITE){
                    ...
                    if(target.figure.figureName === FigureName.KNIGHT && (cell.x === 1 && cell.y === 7)){
                        
                        if(!!target?.figure?.canBlock(cell)!){
                            cell.whiteKnight = !!target?.figure?.canBlock(cell)!
                        }
                        cell.whiteKnight = false
                    }
                    if(target.figure.figureName === FigureName.KNIGHT && (cell.x === 6 && cell.y === 7)){
                        if(!!target?.figure?.canBlock(cell)!){
                ...
                if(!!target?.figure?.canBlock(cell) && target.figure.color === Color.BLACK){
                    ...
                    if(target.figure.figureName === FigureName.KNIGHT && (cell.x === 1 && cell.y === 0)){
                        if(!!target?.figure?.canBlock(cell)!){
                            target.blackKnight = !!target?.figure?.canBlock(cell)!
                        }
                        target.blackKnight = false
                    }
                    if(target.figure.figureName === FigureName.KNIGHT && (cell.x === 6 && cell.y === 0)){
                        if(!!target?.figure?.canBlock(cell)!){
                            target.blackKnight = !!target?.figure?.canBlock(cell)!
                        }
                        target.blackKnight = false
