...
import { Rook } from "./figures/Rook"
    ...
    export class Cell{
        ...
        whiteKingKill(cell: Cell, kingParams: XY, king: Cell, king){
            if(cell.figure?.figureName === FigureName.QUEEN){
                if(this.tryToKillKingHorizontal(cell, kingParams, king) || this.tryToKillKingDiagonal(cell, kingParams) || this.tryToKillKingVertical(cell, kingParams)){
                    return true;
                }
            }
            if(cell.figure?.figureName === FigureName.BISHOP){
