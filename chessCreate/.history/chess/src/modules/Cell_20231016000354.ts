...
import { Rook } from "./figures/Rook"
    ...
    export class Cell{
        ...
        whiteKingKill(cell: Cell, kingParams: XY, blackKing: Cell | null){
            if(cell.figure?.figureName === FigureName.QUEEN){
                if(this.tryToKillKingHorizontal(cell, kingParams, blackKing) || this.tryToKillKingDiagonal(cell, kingParams, blackKing) || this.tryToKillKingVertical(cell, kingParams)){
                    return true;
                }
            }
            if(cell.figure?.figureName === FigureName.BISHOP){
