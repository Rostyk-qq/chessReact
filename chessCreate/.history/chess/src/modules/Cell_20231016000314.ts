    ...
    export class Cell{
        ...
        blackKingKill(cell: Cell, kingParams: XY, whiteKing: Cell | null){
            if(cell.figure?.figureName === FigureName.QUEEN){
                if(this.tryToKillKingHorizontal(cell, kingParams, whiteKing) || this.tryToKillKingDiagonal(cell, kingParams, whiteKing) || this.tryToKillKingVertical(cell, kingParams)){
                    return true;
                }
            }
