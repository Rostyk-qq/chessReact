...
export abstract class Figure{
    ...
    if(this.cell.block){
        console.log('Hello this.cell.block');
        if (figureMainObj && cellForKill) {
            if (cellForKill.cell.figure?.color === Color.BLACK && target.figure?.color === Color.WHITE && target.figure === figureMainObj.figure) {
                console.log('Hello figureMainObj && cellForKill');
                const dx = Math.abs(cellForKill.cell.x - target.x)
                const dy = Math.abs(cellForKill.cell.y - target.y)

                if(cellForKill.cell.x === target.x){
                    console.log('Hello');
                    if(cellForKill.cell.VerticalKill(cellForKill.cell, target)){
                        return true
                    }
                }
