    ...
    public canMove(target: Cell){
        if(!super.canMove(target)){
           return false 
            ...
            if ((this.cell?.figure?.figureName === FigureName.QUEEN && this.cell.figure?.color === Color.BLACK && this.cellForKill.cell?.block) && 
            this.figureMainObj.figure?.color === Color.WHITE && this.cellForKill.cell?.block) {
