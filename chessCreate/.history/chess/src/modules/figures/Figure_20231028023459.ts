        ...
        if(target.board.arrayWhiteFiguresBlock.length){
            this.cell.board.arrayWhiteFiguresBlock.map(figureMain => {
                if(figure.figure?.figureName === FigureName.QUEEN){
                    if(target.blockFigureMovementWhiteKingDiagonal(figure, king) ||
                    target.blockFigureMovementWhiteKingVertical(figure, king) ||
                    target.blockFigureMovementWhiteKingHorizontal(figure, king)){
                        console.log('QUEEN');
                        return true
                    }
                }
