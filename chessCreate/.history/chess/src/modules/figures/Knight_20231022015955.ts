...
export class Knight extends Figure{
    ...
    public canBlock(target: Cell){
        ...
        if(this.cell.figure?.figureName === FigureName.KNIGHT){
            if((this.cell.figure?.color === Color.WHITE || once1 && (this.normalCell?.x === 1 && this.normalCell?.y === 7))){
                once1 = false
            ...
            if((this.cell.figure?.color === Color.WHITE || once2 && (this.normalCell?.x === 6 && this.normalCell?.y === 7))){
                once2 = false
                if((dx === 1 && dy === 2) || (dx === 2 && dy === 1)){
                    target.whiteKnight = true
                }
