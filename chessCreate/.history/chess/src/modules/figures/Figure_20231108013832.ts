...
export abstract class Figure{
    ...
    if(target.board.arrayWhiteFiguresBlock.length){
        ...
        if(this.cell.block){
                if(this.cellBlackProtect.figure?.figureName === FigureName.QUEEN && this.cellBlackProtect.figure?.color === Color.BLACK)
                
                if(this.cell.DiagonalKill(this.cellBlackProtect, this.cellWhiteAttack.cell)){
                    console.log(target);
                    return true
                }
