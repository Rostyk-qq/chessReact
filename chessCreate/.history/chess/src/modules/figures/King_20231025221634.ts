...
export class King extends Figure{
    ...
    public canMove(target: Cell){
        ...
        if(this.cell.figure?.color === Color.WHITE){
            if(target.figure?.blackBishopBigger || target.blackBishopLower || 
                target.figure?.blackKnightBigger|| target.blackKnightLower || 
                target.figure?.blackRookBigger || target.blackRookLower || 
