...
export class Queen extends Figure{
    ...
    public canMove(target: Cell){
        ...
        console.log(this.cellBlackProtect?.block, this.cellBlackProtect?.figure?.figureName, this.cellBlackProtect?.figure?.color);
           
        if(this.cellBlackProtect?.block && this.cellBlackProtect?.figure){
