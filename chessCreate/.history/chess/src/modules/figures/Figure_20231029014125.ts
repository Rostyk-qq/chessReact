...
export abstract class Figure{
    ...
    let cellForKill: Result
    let figureMainObj: FigureBlock
...
Тепер змінні figureMainObj та cellForKill ініціалізуються значенням undefined, і вони перевіряються на наявність значень перед використанням, що запобігає помилці "Variable 'figureMainObj' is used before being assigned".
