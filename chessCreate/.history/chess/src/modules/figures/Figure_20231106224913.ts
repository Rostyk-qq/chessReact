...
export abstract class Figure{
    ...
    if(target.board.arrayWhiteFiguresBlock.length){
        ...
        if(this.cell.block && this.cellBlackProtect?.figure?.color === Color.BLACK){
            if(this.cell === this.cellBlackProtect && this.cell.x === this.cellWhiteAttack?.x ){
                if(this.cell.VerticalKill(target)){
                    return true
                }
                return false
            }
            if(this.cell === this.cellBlackProtect && this.cell.y === this.cellWhiteAttack?.y ){
                if(this.cell.HorizontalKill(target)){
                    return true
                }
                return false
            }
