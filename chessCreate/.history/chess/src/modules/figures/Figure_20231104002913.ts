    ...
    if(target.board.arrayWhiteFiguresBlock.length){
        this.cell.board.arrayWhiteFiguresBlock.map(figureMain => {
            ...
            if(target.figure?.figureName === FigureName.QUEEN){ 
                ...
                if(target.blockFigureMovementDiagonal(target, kingBlack) ||
                target.blockFigureMovementVertical(target, kingBlack) ||
                target.blockFigureMovementHorizontal(target, kingBlack)){

                    let Diagonal = target.blockFigureMovementDiagonal(target, kingBlack)
                    let Vertical = target.blockFigureMovementVertical(target, kingBlack)
                    let Horizontal = target.blockFigureMovementHorizontal(target, kingBlack)
