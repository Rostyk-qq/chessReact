...
export class King extends Figure{
    ...
    public canMove(target: Cell){
        ...
        if(this.cell.figure?.color === Color.BLACK){
            if(this.cell.board.deletedBlackFigures.length){
                this.cell.board.deletedBlackFigures.map(figure => {
                    if(figure.figureName === FigureName.PAWN && figure.cell.blackPawn[figure.uniqValue!]){
                        return true
                    }
                    if(figure.figureName === FigureName.KNIGHT && (figure.cell.blackKnightLower || figure.cell.blackKnightBigger)){
                        return true
                    }
                    if(figure.figureName === FigureName.QUEEN && figure.cell.blackQueen){
                        return true
                    }
                    if(figure.figureName === FigureName.BISHOP && (figure.cell.blackBishopLower || figure.cell.blackBishopBigger)){
                        return true
                    }
                    if(figure.figureName === FigureName.ROOK && (figure.cell.blackRookLower || figure.cell.blackRookBigger)){
                        return true
                    }
                })
            }
            else if((target.whiteBishopBigger || target.whiteBishopLower || 
        ...
        else if(this.cell.figure?.color === Color.WHITE){
