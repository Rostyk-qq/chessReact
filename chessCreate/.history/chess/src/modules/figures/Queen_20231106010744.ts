...
export class Queen extends Figure{
    ...
    public canMove(target: Cell){
        ...
        console.log(this.cellBlackProtectQueen.figure?.color, this.cellWhiteAttackQueen.figure?.color);
            ...
            if ((this.cellWhiteAttackQueen.figure?.figureName === FigureName.QUEEN 
                && this.cellWhiteAttackQueen.figure?.color === Color.WHITE && this.cellBlackProtectQueen.block) 
                ...
                if(this.cell.VerticalKill(this.cellWhiteAttackQueen, this.cellBlackProtectQueen)){
                    return true
                }
                return false
            }
