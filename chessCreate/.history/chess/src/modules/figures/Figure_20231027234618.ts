            ...
            if(target.board.arrayWhiteFiguresBlock.length){
                this.cell.board.arrayWhiteFiguresBlock.map(figureMain => {
                    if(figureMain?.figureName === FigureName.QUEEN){
                        if(this.cell.blockFigureMovementWhiteKingDiagonal(figureMain.cell, figureMain.king) ||
                        this.cell.blockFigureMovementWhiteKingVertical(figureMain.cell, figureMain.king) ||
                        this.cell.blockFigureMovementWhiteKingHorizontal(figureMain.cell, figureMain.king)){
