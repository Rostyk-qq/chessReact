    ...
    if(target.board.arrayWhiteFiguresBlock.length){
        this.cell.board.arrayWhiteFiguresBlock.map(figureMain => {
            if(figureMain.figure?.figureName === FigureName.QUEEN && (target.figure?.figureName === FigureName.KING && target.figure?.color === Color.BLACK) ){ 
                ...
                if(target.blockFigureMovementDiagonal(figureMain.figure?.cell, figureMain.king, this.cell.figure) ||
                ...
                target.blockFigureMovementHorizontal(figureMain.figure?.cell, figureMain.king)){
                    ...
                    let Diagonal = target.blockFigureMovementDiagonal(figureMain.figure?.cell, figureMain.king, this.cell.figure)
                    
                    if(Diagonal){
                        console.log(Diagonal);
                        let Diagonal2 = target.blockFigureMovementDiagonal(figureMain.figure?.cell, figureMain.king, Diagonal.cell!)
                        if(Diagonal.bool){
