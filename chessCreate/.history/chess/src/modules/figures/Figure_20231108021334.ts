...
export abstract class Figure{
    ...
    if(target.board.arrayWhiteFiguresBlock.length){
        ...
        if(this.cell.block){
            if(this.cell.figure?.figureName === FigureName.QUEEN && this.cell.figure?.color === Color.BLACK && target.figure?.color === Color.WHITE && target.figure?.figureName === FigureName.QUEEN){
