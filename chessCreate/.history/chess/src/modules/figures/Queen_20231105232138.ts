...
export class Queen extends Figure{
    ...
    public canMove(target: Cell){
        ...
        this.cellWhiteAttackQueen;
        console.log(this.figureMainObj.figure?.cell.block);

            if ((this.cellBlackProtectQueen?.figure?.figureName === FigureName.QUEEN && this.cellBlackProtectQueen?.figure?.color === Color.BLACK) && 
            this.cellWhiteAttackQueen.cell?.figure?.color === Color.WHITE && this.figureMainObj.figure?.cell.block) {
