    ...
    if(target.board.arrayWhiteFiguresBlock.length){
        ...
        this.cell.board.arrayWhiteFiguresBlock.map(figureMain => {
            console.log(figureMain.king);
                ...
                if((figureMain.figure?.figureName === FigureName.ROOK && figureMain.figure?.color === Color.WHITE) && target.blockFigureMovementDiagonalBlackKing(figureMain.figure?.cell , figureMain.king)){
