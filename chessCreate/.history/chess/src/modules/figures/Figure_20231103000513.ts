...
export abstract class Figure{
    ...
    if(target.board.arrayWhiteFiguresBlock.length){
        this.cell.board.arrayWhiteFiguresBlock.map(figureMain => {
            if(figureMain.figure?.figureName === FigureName.QUEEN && this.cell.figure && (target.figure?.figureName === FigureName.KING  &&  target.figure.color === Color.WHITE)){ 
            ...
            if(figureMain.figure?.figureName === FigureName.ROOK && this.cell.figure){
