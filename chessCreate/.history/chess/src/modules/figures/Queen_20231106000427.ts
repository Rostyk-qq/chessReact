...
export class Queen extends Figure{
    ...
    public canMove(target: Cell){
        ...
        console.log(this.cell.figure?.cellBlackProtectQueen.x === target.figure?.cellWhiteAttackQueen.x);
        
            if ((this.cell.figure?.cellBlackProtectQueen.figure?.figureName === FigureName.QUEEN 
                && this.cell.figure?.cellBlackProtectQueen.figure?.color === Color.BLACK && this.cell.figure?.cellBlackProtectQueen.block) 
                && target.figure?.cellWhiteAttackQueen.figure?.color === Color.WHITE && this.cell.figure?.cellBlackProtectQueen.x === target.figure?.cellWhiteAttackQueen.x) {

                if(this.cell.figure.cellBlackProtectQueen.moveVertical(target.figure.cellWhiteAttackQueen)){
                    return true
                }
                return false
            }
