        ...
        this.cell.board.arrayWhiteFiguresBlock.map(figureMain => {
            if(figureMain.figure?.figureName === FigureName.QUEEN){
                ...
                target.blockFigureMovementWhiteKingHorizontal(figureMain.figure?.cell, figureMain.king)){
                    ...
                    const Vertical = target.blockFigureMovementWhiteKingDiagonal(figureMain.figure?.cell, figureMain.king)
                    const Horizontal = target.blockFigureMovementWhiteKingDiagonal(figureMain.figure?.cell, figureMain.king)
                    console.log('QUEEN');
                    return true
                }
            }
