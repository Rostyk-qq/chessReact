...
export abstract class Figure{
    ...
    if(target.board.arrayWhiteFiguresBlock.length){
        ...
        if(this.cell.block && this.cellBlackProtect?.figure?.color === Color.BLACK && this.cellWhiteAttack?.figure?.color === Color.WHITE){
            if(this.cell === this.cellBlackProtect && target === this.cellWhiteAttack && this.cell.x === this.cellWhiteAttack?.x ){
                if(this.cell.VerticalKill(this.cell, target)){
                    return true
                }
            }
            if(this.cell === this.cellBlackProtect && target === this.cellWhiteAttack && this.cell.y === this.cellWhiteAttack?.y ){
