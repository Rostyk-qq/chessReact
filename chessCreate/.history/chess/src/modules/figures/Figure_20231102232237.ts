...
export abstract class Figure{
    ...
    if(target.board.arrayWhiteFiguresBlock.length){
        this.cell.board.arrayWhiteFiguresBlock.map(figureMain => {
            if(figureMain.figure?.figureName === FigureName.QUEEN && target.figure && this.cell.figure){ 
            ...
            if(figureMain.figure?.figureName === FigureName.ROOK && target.figure && this.cell.figure){
                ...
                if(figureMain.figure?.figureName === FigureName.BISHOP && target.figure && this.cell.figure){
                    if(target.blockFigureMovementDiagonal(figureMain.figure?.cell, figureMain.king)){
