...
export class Pawn extends Figure{
    ...
    public canBlock(target: Cell){
        ...
        if(this.cell.figure?.color === Color.WHITE && this.cell.figure?.figureName === FigureName.PAWN && target.figure?.color === Color.BLACK && cell.figure?.figureName === FigureName.QUEEN){                
