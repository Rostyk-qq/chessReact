...
export abstract class Figure{
    ...
    public canMove(target: Cell){
        ...
        if(target.figure?.figureName === FigureName.KING && target.figure.color === Color.BLACK){
            kingBlack.x = target.x
            kingBlack.y = target.y
        }
    ...
    if(target.board.arrayWhiteFiguresBlock.length){
        this.cell.board.arrayWhiteFiguresBlock.map(figureMain => {
            if(figureMain.figure?.figureName === FigureName.QUEEN && this.cell.figure && (target.figure?.figureName === FigureName.KING  &&  target.figure.color === Color.BLACK)){ 
                ...
                target.blockFigureMovementHorizontal(figureMain.figure?.cell, {x: target.x, y: target.y})){
                    ...
                    let Diagonal = target.blockFigureMovementDiagonal(figureMain.figure?.cell, figureMain.king)
                    // let Vertical = target.blockFigureMovementVertical(figureMain.figure?.cell, {x: target.x, y: target.y})
                    let Horizontal = target.blockFigureMovementHorizontal(figureMain.figure?.cell, {x: target.x, y: target.y})
            ...
            // if(figureMain.figure?.figureName === FigureName.ROOK && this.cell.figure && (target.figure?.figureName === FigureName.KING  &&  target.figure.color === Color.BLACK)){
            //     if(target.blockFigureMovementVertical(figureMain.figure?.cell , {x: target.x, y: target.y}) ||
            //     target.blockFigureMovementHorizontal(figureMain.figure?.cell , {x: target.x, y: target.y})){
            ...
            //     if(figureMain.figure?.figureName === FigureName.BISHOP && this.cell.figure && (target.figure?.figureName === FigureName.KING  &&  target.figure.color === Color.BLACK)){
            //         if(target.blockFigureMovementDiagonal(figureMain.figure?.cell, figureMain.king)){
