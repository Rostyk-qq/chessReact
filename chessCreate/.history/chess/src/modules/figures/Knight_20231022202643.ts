    ...
    public canMove(target: Cell){
        ...
        public canBlock(target: Cell){
            ...
            if(this.cell.figure?.color === Color.WHITE){
                ...
                else if((this.cell.x === Math.abs(this.thisCell?.x! - 1) && this.thisCell?.y! === Math.abs(this.cell.y - 2)) ||
                (this.cell.x === Math.abs(this.thisCell?.x! + 1) && this.thisCell?.y! === Math.abs(this.thisCell?.y! - 2)) ||
                (this.cell.x === Math.abs(this.thisCell?.x! - 1) && this.thisCell?.y! === Math.abs(this.thisCell?.y! + 2)) ||
                (this.cell.x === Math.abs(this.thisCell?.x! + 1) && this.thisCell?.y! === Math.abs(this.thisCell?.y! + 2)) 
                && 
                (this.cell.x === Math.abs(this.thisCell?.x! - 2) && this.thisCell?.y! === Math.abs(this.thisCell?.y! - 1)) ||
                (this.cell.x === Math.abs(this.thisCell?.x! - 2) && && this.thisCell?.y! === Math.abs(this.thisCell?.y! + 1)) ||
                (this.cell.x === Math.abs(this.thisCell?.x! + 2) && && this.thisCell?.y! === Math.abs(this.thisCell?.y! - 1)) ||
                (this.cell.x === Math.abs(this.thisCell?.x! + 2) && && this.thisCell?.y! === Math.abs(this.thisCell?.y! + 1))){
                    this.cell.whiteKnight = false
                } 
            }
        }
}