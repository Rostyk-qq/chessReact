        ...
        this.cell.board.arrayWhiteFiguresBlock.map(figureMain => {
            if(figureMain.figure?.figureName === FigureName.QUEEN && target.figure?.color === Color.WHITE){ 
                ...
                target.blockFigureMovementHorizontal(figureMain.figure?.cell, {x: target.x, y: target.y})){
                    ...
                    const Vertical = target.blockFigureMovementVertical(figureMain.figure?.cell, {x: this.cell.x, y: target.y})
                    const Horizontal = target.blockFigureMovementHorizontal(figureMain.figure?.cell, {x: this.cell.x, y: target.y})
