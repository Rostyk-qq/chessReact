...
export abstract class Figure{
    ...
    if(target.board.arrayWhiteFiguresBlock.length){
        ...
        if(this.cell.block){
            ...
            this.cell.board.arrayWhiteFiguresKingMovement.map(cellQ => {
                if(this.cell.figure?.color === Color.BLACK && target.figure?.color === Color.WHITE && (cellQ.k.x === target.x || this.cell.x === target.x || dx === dy)){
