...
export class King extends Figure{
    ...
    checkHorizontalForKing(cell: Cell, kingParams: XY){  
    ...
    checkVerticalForKing(cell: Cell){  
    ...
    checkKnightForKing(cell: Cell, kingParams: XY){ 
    ...
    checkPawnForKing(cell: Cell, kingParams: XY){
