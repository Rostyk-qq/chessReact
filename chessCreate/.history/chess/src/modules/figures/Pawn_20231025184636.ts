...
export class Pawn extends Figure{
    ...
    public canBlock(target: Cell){
        ...
        if(this.cell.figure?.color === Color.WHITE && this.cell.figure?.figureName === FigureName.PAWN && cell.figure?.color === Color.BLACK && cell.figure?.figureName === FigureName.QUEEN){                
