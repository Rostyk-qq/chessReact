...
export class Queen extends Figure{
    ...
    public canMove(target: Cell){
        ...
        console.log(this.cellBlackProtectQueen.figure?.color, this.cellWhiteAttackQueen.x);
        
            if ((this.cellBlackProtectQueen.figure?.figureName === FigureName.QUEEN && this.cellBlackProtectQueen.block) 
