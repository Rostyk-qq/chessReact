            ...
            if(this.cell.board.arrayWhiteFiguresKingMovement.length){
                this.cell.board.arrayWhiteFiguresKingMovement.map(figure => {
                    if(figure?.figureName === FigureName.QUEEN){
                        if(this.cell.kingMovementWhiteDiagonal(figure.cell) 
                        || this.cell.kingMovementWhiteVertical(figure.cell) 
                        || this.cell.kingMovementWhiteHorizontal(figure.cell)){
                    ...
                    if(figure?.figureName === FigureName.ROOK){
                        if(this.cell.kingMovementWhiteVertical(figure.cell) 
                        || this.cell.kingMovementWhiteHorizontal(figure.cell)){}
            ...
            if(this.cell.board.arrayBlackFiguresKingMovement.length){
                this.cell.board.arrayBlackFiguresKingMovement.map(figure => {
                    if(figure?.figureName === FigureName.QUEEN){
                        ...
                        if(this.cell.kingMovementBlackVertical(figure.cell)){
                            target.blackQueen = false
                            return true
                        }
                        if(this.cell.kingMovementBlackHorizontal(figure.cell)){
                            target.blackQueen = false
                            return true
                        }
                    }
