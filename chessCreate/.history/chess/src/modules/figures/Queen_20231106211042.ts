...
export class Queen extends Figure{
    ...
    public canMove(target: Cell){
        ...
        console.log(this.cellBlackProtect?.block, this.cellBlackProtectQueen?.figure?.figureName, this.cellBlackProtectQueen?.figure?.color);
           
        if(this.cellBlackProtect?.block){
            if(this.cellBlackProtect?.x === this.cellWhiteAttackQueen?.x){
