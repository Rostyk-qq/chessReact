...
export abstract class Figure{
    ...
    if(target.board.arrayWhiteFiguresBlock.length){
        this.cell.board.arrayWhiteFiguresBlock.map(figureMain => {
            if(figureMain.figure?.figureName === FigureName.QUEEN && (target.figure?.figureName === FigureName.KING && target.figure?.color === Color.BLACK) && target.figure?.color === Color.BLACK){ 
             
                if(target.blockFigureMovementDiagonal(figureMain.figure?.cell, {x: this.cell.x, y: this.cell.y}) ||
                target.blockFigureMovementVertical(figureMain.figure?.cell, {x: this.cell.x, y: this.cell.y}) ||
                target.blockFigureMovementHorizontal(figureMain.figure?.cell, {x: this.cell.x, y: this.cell.y})){
                    
                    const Diagonal = target.blockFigureMovementDiagonal(figureMain.figure?.cell, {x: this.cell.x, y: this.cell.y})
            ...
            if(figureMain.figure?.figureName === FigureName.ROOK || figureMain.figure?.figureName === FigureName.KING){
                ...
                if(figureMain.figure?.figureName === FigureName.BISHOP || figureMain.figure?.figureName === FigureName.KING){
