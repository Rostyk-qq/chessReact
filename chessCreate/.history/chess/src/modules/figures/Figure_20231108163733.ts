...
export abstract class Figure{
    ...
    if(target.board.arrayWhiteFiguresBlock.length){
        ...
        if(this.cell.block && this.cellBlackProtect.figure?.figureName === FigureName.QUEEN 
            && this.cellBlackProtect.figure?.color === Color.BLACK && this.cellWhiteAttack.cell.figure?.color === Color.WHITE
