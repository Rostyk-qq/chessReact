    ...
    if(target.board.arrayWhiteFiguresBlock.length){
        ...
        this.cell.board.arrayWhiteFiguresBlock.map(figureMain => {
            console.log(figureMain.king);
                ...
                if((figureMain.figure?.figureName === FigureName.ROOK && figureMain.figure?.figureName === FigureName.ROOK) && (target.blockFigureMovementVerticalBlackKing(figureMain.figure?.cell , figureMain.king) ||
                target.blockFigureMovementHorizontalBlackKing(figureMain.figure?.cell , figureMain.king))){
                    const Vertical = target.blockFigureMovementVerticalBlackKing(figureMain.figure?.cell, figureMain.king)
                    const Horizontal = target.blockFigureMovementHorizontalBlackKing(figureMain.figure?.cell, figureMain.king)
