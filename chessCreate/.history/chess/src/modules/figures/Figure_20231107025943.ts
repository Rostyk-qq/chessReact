        ...
        if(this.cell.block && this.cellBlackProtect?.figure?.color === Color.BLACK && this.cellWhiteAttack?.figure?.color === Color.WHITE){
            if(this.cell === this.cellBlackProtect){
                ...
                if(target === this.cellWhiteAttack){
                    ...
                    for (let i = 1; i <= dx; i++) {
                        if(this.cell.board.getCell(this.cell.y + (i * directionY), this.cell.x + (i * directionX)).figure?.canMove(this.cell.board.getCell(this.cell.y + (i * directionY), this.cell.x + (i * directionX)))
                        )
                    }
                    return false 
                }
