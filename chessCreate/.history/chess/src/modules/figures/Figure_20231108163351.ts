...
export abstract class Figure{
    ...
    cellBlackProtectQueenDiagonal: Cell;
    cellWhiteAttackQueenDiagonal: Figure
    ...
    constructor(color: Color, cell: Cell, uniqValue: number | null ) {
        ...
        this.cellBlackProtectQueenDiagonal = this.cell;
        this.cellWhiteAttackQueenDiagonal = this;
    }
    ...
    if(target.board.arrayWhiteFiguresBlock.length){
                ...
                target.blockFigureMovementHorizontalQueen(figureMain.figure?.cell, kingBlack)){
                    ...
                    if(Diagonal){
                        if(Diagonal.bool){
                            ...
                            this.cellBlackProtectQueenDiagonal= Diagonal.cell;
                            this.cellWhiteAttackQueenDiagonal = figureMain.figure;
                        }
                        else{ 
                            if(Diagonal.cell){
        ...
        if(this.cellBlackProtectQueenDiagonal && this.cellWhiteAttackQueenDiagonal){
                    console.log(target);
                    if(this.cell.DiagonalKill(this.cellBlackProtectQueenDiagonal, this.cellWhiteAttackQueenDiagonal.cell)){
                        return true
                    }
                    return false
