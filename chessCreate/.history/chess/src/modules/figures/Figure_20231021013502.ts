...
export abstract class Figure{
    ...
    this.cell.figure?.figureName === FigureName.ROOK 
            ...
            && ((this.cell.figure?.cell.y === 7 && this.cell.figure?.cell.x === 0) || (this.cell.figure?.cell.y === 7 && this.cell.figure?.cell.x === 7)) 
            && target.figure?.figureName === FigureName.KING 
            && (target.figure?.color === Color.WHITE || target.figure?.color === Color.BLACK)
        )
    ...
    public canMove(target: Cell){
        ...
        &&
        (((this.cell.y === 7 && this.cell.x === 0) && (target.y === 0 && target.x === 3)) || 
        ((this.cell.y === 7 && this.cell.x === 7) && (target.y === 0 && target.x === 3)) || 
        ((this.cell.y === 0 && this.cell.x === 7) && (target.y === 7 && target.x === 3)) || 
        ((this.cell.y === 0 && this.cell.x === 0) && (target.y === 7 && target.x === 3)))
        ){
            setTimeout(() => {
