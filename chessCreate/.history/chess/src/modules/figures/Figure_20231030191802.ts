...
export abstract class Figure{
    ...
    let kingWhite, kingBlack: Cell = target;
    ...
    if(target.board.arrayWhiteFiguresBlock.length){
        this.cell.board.arrayWhiteFiguresBlock.map(figureMain => {
            if(figureMain.figure?.figureName === FigureName.QUEEN || (target.figure?.figureName === FigureName.KING  &&  target.figure.color === Color.BLACK)){
                ...
                if(target.blockFigureMovementDiagonalBlackKing(figureMain.figure?.cell, kingBlack) ||
                target.blockFigureMovementVerticalBlackKing(figureMain.figure?.cell, kingBlack) ||
                target.blockFigureMovementHorizontalBlackKing(figureMain.figure?.cell, kingBlack)){

                    const Diagonal = target.blockFigureMovementDiagonalBlackKing(figureMain.figure?.cell, kingBlack)
                    const Vertical = target.blockFigureMovementVerticalBlackKing(figureMain.figure?.cell, kingBlack)
                    const Horizontal = target.blockFigureMovementHorizontalBlackKing(figureMain.figure?.cell, kingBlack)
