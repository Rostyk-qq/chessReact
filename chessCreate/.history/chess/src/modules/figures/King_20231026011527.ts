...
export class King extends Figure{
    ...
    public canMove(target: Cell){
        ...
        if(this.cell.figure?.color === Color.BLACK){
            ...
            if(!target.whiteBishopBigger){
                return true
            }
            else if(!target.whiteBishopLower){
                return true
            }
            else if(!target.whiteKnightBigger){
                return true
            }
            else if(!target.whiteKnightLower){
                return true
            }     
            else if(target.whiteRookBigger){
                return true
            }
            else if(!target.whiteRookLower){
                return true
            }
