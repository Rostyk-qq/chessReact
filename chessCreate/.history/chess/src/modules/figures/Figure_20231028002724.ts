    ...
    public canMove(target: Cell){
            ...
            if(this.cell.figure?.color === Color.WHITE){    
                        ...
                        if(this.cell.figure?.figureName === FigureName.ROOK){
                            if(target.blockFigureMovementWhiteKingVertical(this.cell.figure.cell, figureMain.king) ||
                            target.blockFigureMovementWhiteKingHorizontal(this.cell.figure.cell, figureMain.king)){
