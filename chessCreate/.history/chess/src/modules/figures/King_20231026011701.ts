...
export class King extends Figure{
    ...
    public canMove(target: Cell){
        ...
        if(this.cell.figure?.color === Color.BLACK){
            ...
            if (
                !target.whiteBishopBigger ||
                !target.whiteBishopLower ||
                !target.whiteKnightBigger ||
                !target.whiteKnightLower ||
                target.whiteRookBigger ||
                !target.whiteRookLower ||
                !target.whiteQueen
            ) {
                return true;
            } else {
            ...
            In this refactored code, we first initialize the target object with default values, and then we use a switch statement to update the properties of the target object based on the conditions. Finally, we check the conditions and return true or false accordingly.
