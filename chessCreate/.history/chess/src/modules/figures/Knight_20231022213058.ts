    ...
    public canMove(target: Cell){
        ...
        public canBlock(target: Cell){
            ...
            if(this.cell.figure?.color === Color.WHITE){
                    if(((dx === 1 && dy === 2) || (dx === 2 && dy === 1)) && this.cell.figure?.uniqValue === 1111){
                        target.whiteKnight = true
                        return true
                    }
                    if(((dx === 1 && dy === 2) || (dx === 2 && dy === 1)) && this.cell.figure?.uniqValue === 2222){
                        target.whiteKnight = true
                        return true
                    }
                    if(target.whiteKnight && this.cell.figure?.uniqValue === 1111){
                        target.whiteKnight = false      
                    }
                    if(target.whiteKnight && this.cell.figure?.uniqValue === 2222){
                        target.whiteKnight = false      
                    }
            }
        }
