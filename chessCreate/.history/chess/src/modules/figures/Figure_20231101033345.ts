    ...
    if(target.board.arrayWhiteFiguresBlock.length){
        this.cell.board.arrayWhiteFiguresBlock.map(figureMain => {
            if(figureMain.figure?.figureName === FigureName.QUEEN && (target.figure?.figureName === FigureName.KING && target.figure?.color === Color.BLACK)){ 
                ...
                if(target.blockFigureMovementDiagonal(figureMain.figure?.cell, {x: target.x, y: target.y}, null) ||
                ...
                target.blockFigureMovementHorizontal(figureMain.figure?.cell, {x: target.x, y: target.y})){
                    ...
                    let  Diagonal = target.blockFigureMovementDiagonal(figureMain.figure?.cell, {x: target.x, y: target.y}, null)
                    ...
                    if(Diagonal){
                        ...
                        if(Diagonal.bool){
                            ...
                            Diagonal = target.blockFigureMovementDiagonal(figureMain.figure?.cell, {x: target.x, y: target.y}, Diagonal.cell)
