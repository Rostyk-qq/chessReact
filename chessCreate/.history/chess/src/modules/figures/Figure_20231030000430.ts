    ...
    if(target.board.arrayWhiteFiguresBlock.length){
        this.cell.board.arrayWhiteFiguresBlock.map(figureMain => {
            if(figureMain.figure?.figureName === FigureName.QUEEN || (target.figure?.figureName === FigureName.KING  &&  target.figure.color === Color.BLACK)){
                ...
                if(target.blockFigureMovementDiagonalBlackKing(figureMain.figure?.cell, figureMain.king) ||
                target.blockFigureMovementVerticalBlackKing(figureMain.figure?.cell, figureMain.king) ||
                target.blockFigureMovementHorizontalBlackKingRight(figureMain.figure?.cell, figureMain.king) ||
                target.blockFigureMovementHorizontalBlackKingLeft(figureMain.figure?.cell, figureMain.king)){

                    const Diagonal = target.blockFigureMovementDiagonalBlackKing(figureMain.figure?.cell, figureMain.king)
                    const Vertical = target.blockFigureMovementVerticalBlackKing(figureMain.figure?.cell, figureMain.king)
                    const HorizontalLeft = target.blockFigureMovementHorizontalBlackKingLeft(figureMain.figure?.cell, figureMain.king)
                    const HorizontalRight = target.blockFigureMovementHorizontalBlackKingRight(figureMain.figure?.cell, figureMain.king)
            ...
            if(figureMain.figure?.figureName === FigureName.ROOK || (target.figure?.figureName === FigureName.KING  &&  target.figure.color === Color.BLACK)){
                if(target.blockFigureMovementVerticalBlackKing(figureMain.figure?.cell , figureMain.king) ||
                target.blockFigureMovementHorizontalBlackKing(figureMain.figure?.cell , figureMain.king)){
                    const Vertical = target.blockFigureMovementVerticalBlackKing(figureMain.figure?.cell, figureMain.king)
                    const Horizontal = target.blockFigureMovementHorizontalBlackKing(figureMain.figure?.cell, figureMain.king)
            ...
            if(figureMain?.figure?.figureName === FigureName.BISHOP || (target.figure?.figureName === FigureName.KING  &&  target.figure.color === Color.BLACK)){    
                ...
                if(target.blockFigureMovementDiagonalBlackKing(figureMain.figure?.cell , figureMain.king)){
                    ...
                    cell = target.blockFigureMovementDiagonalBlackKing(figureMain.figure?.cell, figureMain.king)!
                    if(cell.bool){
    ...
    if(target.board.arrayBlackFiguresBlock.length){
        this.cell.board.arrayBlackFiguresBlock.map(figureMain => {
            if(figureMain.figure?.figureName === FigureName.QUEEN || (target.figure?.figureName === FigureName.KING  &&  target.figure.color === Color.WHITE)){
                ...
                target.blockFigureMovementVerticalWhiteKing(figureMain.figure?.cell, figureMain.king) ||
                target.blockFigureMovementHorizontalWhiteKingLeft(figureMain.figure?.cell, figureMain.king) || 
                target.blockFigureMovementHorizontalWhiteKingRight(figureMain.figure?.cell, figureMain.king)){

                    const Diagonal = target.blockFigureMovementDiagonalWhiteKing(figureMain.figure?.cell, figureMain.king)
                    const Vertical = target.blockFigureMovementVerticalWhiteKing(figureMain.figure?.cell, figureMain.king)
                    const HorizontalLeft = target.blockFigureMovementHorizontalWhiteKingLeft(figureMain.figure?.cell, figureMain.king)
                    const HorizontalRight = target.blockFigureMovementHorizontalWhiteKingRight(figureMain.figure?.cell, figureMain.king)
                    ...
                    if(figureMain.figure.cell.x <= 4){
                        console.log('Left');

                        if(HorizontalLeft.bool){
                            HorizontalLeft.cell.block = true

                            cellForKill = HorizontalLeft
                            figureMainObj = figureMain
                        }
                        target.block = false
                    }
                    if(figureMain.figure.cell.x >= 4){
                        ...
                        if(HorizontalRight.bool){
                            HorizontalRight.cell.block = true

                            cellForKill = HorizontalRight
                            figureMainObj = figureMain
                        }
                        target.block = false
                    }
            ...
            if(figureMain.figure?.figureName === FigureName.ROOK || (target.figure?.figureName === FigureName.KING  &&  target.figure.color === Color.WHITE)){
                if(target.blockFigureMovementVerticalWhiteKing(figureMain.figure?.cell , figureMain.king) ||
                target.blockFigureMovementHorizontalWhiteKingRight(figureMain.figure?.cell , figureMain.king)
                || target.blockFigureMovementHorizontalWhiteKingLeft(figureMain.figure?.cell , figureMain.king)){
                    const Vertical = target.blockFigureMovementVerticalWhiteKing(figureMain.figure?.cell, figureMain.king)
                    const HorizontalLeft = target.blockFigureMovementHorizontalWhiteKingLeft(figureMain.figure?.cell, figureMain.king)
                    const HorizontalRight = target.blockFigureMovementHorizontalWhiteKingLeft(figureMain.figure?.cell, figureMain.king)
