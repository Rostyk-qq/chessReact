        ...
        if(!super.canMove(target)){
           return false 
            ...
            this.cellForKill.cell?.figure?.color === Color.WHITE) {
                ...
                if(this.figureMainObj.figure.cell.x === this.cellForKill.cell.x && arget.figure?.cell === this.cellForKill.cell && this.cell.figure?.cell === this.figureMainObj.figure.cell){
