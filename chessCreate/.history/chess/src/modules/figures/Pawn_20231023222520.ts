...
export class Pawn extends Figure{
    ...
    public canBlock(target: Cell){
        ...
        if(this.cell.figure?.color === Color.BLACK){
            const stepOne = this.cell.figure?.color === Color.BLACK ? 1 : -1
            if(target.y === this.cell.y + stepOne && (target.x === this.cell.x + 1 || target.x === this.cell.x - 1)){
                    if(this.uniqValue === 10){
                        target.blackPawn1 = true
                        return true
                    }
                    if(this.uniqValue === 11){
                        target.blackPawn2 = true
                        return true
                    }
                    if(this.uniqValue === 12){
                        target.blackPawn3 = true
                        return true
                    }
                    if(this.uniqValue === 13){
                        target.blackPawn4 = true
                        return true
                    }
                    if(this.uniqValue === 14){
                        target.blackPawn5 = true
                        return true
                    }
                    if(this.uniqValue === 15){
                        target.blackPawn6 = true
                        return true
                    }
                    if(this.uniqValue === 16){
                        target.blackPawn7 = true
                        return true
                    }  
                    if(this.uniqValue === 17){
                        target.blackPawn8 = true
                        return true
                    }
            }
            if(this.cell.figure?.uniqValue === 0){
