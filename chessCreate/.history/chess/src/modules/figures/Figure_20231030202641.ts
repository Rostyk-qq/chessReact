    ...
    if(target.board.arrayWhiteFiguresBlock.length){
        ...
        this.cell.board.arrayWhiteFiguresBlock.map(figureMain => {
            console.log(figureMain.king);
                if(target.figure?.figureName === FigureName.QUEEN && target.figure?.color === Color.WHITE && (target.blockFigureMovementDiagonal(figureMain.figure?.cell, figureMain.king) ||
