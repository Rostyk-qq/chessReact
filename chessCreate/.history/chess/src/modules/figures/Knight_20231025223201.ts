            ...
            if(this.cell.figure?.color === Color.WHITE){
                    if(((dx === 1 && dy === 2) || (dx === 2 && dy === 1))){
                        if(this.cell.figure?.uniqValue === 1111){
                            target.figure!.whiteKnightLower = true
                            return true
                        }
                        if(this.cell.figure?.uniqValue === 2222){
                            target.figure!.whiteKnightBigger = true
                            return true
                        }
                    }
                    if(this.cell.figure?.uniqValue === 1111){
                        target.figure!.whiteKnightLower = false      
                    }
                    if(this.cell.figure?.uniqValue === 2222){
                        target.figure!.whiteKnightBigger = false      
                    }
            }
            if(this.cell.figure?.color === Color.BLACK){
                if(((dx === 1 && dy === 2) || (dx === 2 && dy === 1))){
                    if(this.cell.figure?.uniqValue === 3333){
                        target.figure!.blackKnightLower = true
                        return true
                    }
                    if(this.cell.figure?.uniqValue === 4444){
                        target.figure!.blackKnightBigger = true
                        return true
                    }
                }
                if(this.cell.figure?.uniqValue === 1111){
                    target.figure!.blackKnightLower = false      
                }
                if(this.cell.figure?.uniqValue === 2222){
                    target.figure!.blackKnightBigger = false      
                }
        }
        }
}