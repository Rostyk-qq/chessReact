...
export abstract class Figure{
    ...
    cellBlackProtectQueen: Cell;
    cellWhiteAttackQueen: Cell

    cellBlackProtectRook: Cell
    cellWhiteAttackRook: Cell

    cellBlackProtectBishop: Cell
    cellWhiteAttackBishop: Cell
    ...
    constructor(color: Color, cell: Cell, uniqValue: number | null ) {
        ...
        this.cellBlackProtectQueen = this.cell;
        this.cellWhiteAttackQueen = this.cell;

        this.cellBlackProtectRook = this.cell;
        this.cellWhiteAttackRook = this.cell;

        this.cellBlackProtectBishop = this.cell;
        this.cellWhiteAttackBishop = this.cell;
    }
                ...
                target.blockFigureMovementHorizontalQueen(figureMain.figure?.cell, kingBlack)){
                    ...
                    if(Diagonal){
                        if(Diagonal.bool){
                            ...
                            if(this.cellBlackProtectQueen.figure?.color === Color.BLACK && this.cellWhiteAttackQueen.figure?.color === Color.WHITE){
