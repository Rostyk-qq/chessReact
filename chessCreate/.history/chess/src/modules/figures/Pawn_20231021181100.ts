...
export class Pawn extends Figure{
   ...
   public canBlock(target: Cell){
    ...
    if(this.cell.figure?.color === Color.WHITE && target.y === this.cell.y + stepOne && target.x === this.cell.x){
    ...
    if(this.cell.figure?.color === Color.BLACK && target.y === this.cell.y + stepOne && target.x === this.cell.x){
        const stepOne = this.cell.figure?.color === Color.BLACK ? 1 : -1
