...
export class Queen extends Figure{
    ...
    public canMove(target: Cell){
        ...
        console.log(this.cell.cellBlackProtectQueen.figure?.color, target.cellWhiteAttackQueen.figure?.color);
        
            if ((this.cell.cellBlackProtectQueen.figure?.figureName === FigureName.QUEEN && this.cell.cellBlackProtectQueen.figure?.color === Color.BLACK && this.cell.cellBlackProtectQueen.block) 
                && this.cell.cellBlackProtectQueen.x === target.cellWhiteAttackQueen.x) {
                    
                    console.log(target.cellWhiteAttackQueen);
                    
                if(this.cell.cellBlackProtectQueen.moveVertical(target.cellWhiteAttackQueen)){
                    return true
                }
                return false
            }
