...
export class Knight extends Figure{
    ...
    public canBlock(target: Cell){
        ...
        if(this.cell.figure?.figureName === FigureName.KNIGHT){
            if((once1 && (this.normalCell?.x === 1 && this.normalCell?.y === 7)) || this.cell.figure?.color === Color.WHITE){
                once1 = false
            ...
            if((once1 && (this.normalCell?.x === 1 && this.normalCell?.y === 0)) || this.cell.figure?.color === Color.BLACK){
                once1 = false
                if((dx === 1 && dy === 2) || (dx === 2 && dy === 1)){
