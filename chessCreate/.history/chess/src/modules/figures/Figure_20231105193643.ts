        ...
        if (figureMainObj && cellForKill) {
            ...
            if (cellForKill.cell.figure?.color === Color.BLACK && figureMainObj.figure) {
                ...
                if(cellForKill.cell.x === figureMainObj.figure.cell.x){
                    ...
                    const max = Math.max(start.y, figureMainObj.figure.cell.y)
                    const min = Math.max(start.y, figureMainObj.figure.cell.y)
    
                    const directionY = start.y < figureMainObj.figure.cell.y ? 1 : -1;
