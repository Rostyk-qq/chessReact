    ...
    public canMove(target: Cell){
        ...
        public canBlock(target: Cell){
            ...
            if(this.cell.figure?.color === Color.WHITE){
                ...
                else if((this.cell.x === this.thisCell?.x! - 1 || this.cell.x === Math.abs(this.thisCell?.x! - 2) || 
                this.cell.x === this.thisCell?.x! + 1 || this.cell.x === this.thisCell?.x! + 2) && (
                this.cell.y === this.thisCell?.y! - 2 || this.cell.y === this.thisCell?.y! + 2 || 
                this.cell.y === this.thisCell?.y! + 1 || this.cell.y === this.thisCell?.y! + 1)){
