...
export abstract class Figure{
    ...
    public canMove(target: Cell){
        ...
        let cellBlackProtect: Cell = this.cell;
        let cellWhiteAttack: Figure = this;
    ...
    if(target.board.arrayWhiteFiguresBlock.length){
                ...
                target.blockFigureMovementHorizontalQueen(figureMain.figure?.cell, kingBlack)){
                    ...
                    if(Diagonal){
                        if(Diagonal.bool){
                            ...
                            cellBlackProtect= Diagonal.cell;
                            cellWhiteAttack = figureMain.figure;
                        }
                        else{ 
                            if(Diagonal.cell){
                    ...
                    if(Vertical){
                        if(Vertical.bool){
                            ...
                            cellBlackProtect= Vertical.cell;
                            cellWhiteAttack = figureMain.figure;
                        }
                        else{
                            if(Vertical.cell){
                    ...
                    if(Horizontal){
                        if(Horizontal.bool){
                            ...
                            cellBlackProtect = Horizontal.cell;
                            cellWhiteAttack = figureMain.figure;
                        }
                        else{
                            if(Horizontal.cell){
        ...
        if(this.cell.block){
                if(cellBlackProtect.figure?.figureName === FigureName.QUEEN && cellBlackProtect.figure?.color === Color.BLACK)
                
                if(this.cell.DiagonalKill(cellBlackProtect, cellWhiteAttack.cell)){
                    console.log(cellBlackProtect, cellWhiteAttack.cell);
                    return true
                }
