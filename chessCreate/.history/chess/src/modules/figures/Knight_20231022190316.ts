...
export class Knight extends Figure{
    ...
    public canBlock(target: Cell){
            ...
            if(this.cell.figure?.color === Color.WHITE && (this.cell.x === Math.abs(this.thisCell?.x! - 1) 
            || this.cell.x === Math.abs(this.thisCell?.x! - 2))
            && (this.cell.y === Math.abs(this.thisCell?.y! - 1) 
            || this.cell.y === Math.abs(this.thisCell?.y! - 2))){
