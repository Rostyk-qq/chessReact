    ...
    public canMove(target: Cell){
        ...
        if(this.cell.figure?.color === Color.BLACK){
            if(target.whiteBishopBigger || target.whiteBishopLower || 
                ...
                target.whiteQueen || target.whitePawn1 || target.whitePawn2 || target.whitePawn3
                || target.whitePawn4 || target.whitePawn5 || target.whitePawn6 || target.whitePawn7
                || target.whitePawn8){
                    return false
            }
        }
        if(this.cell.figure?.color === Color.WHITE){
            if(target.blackBishopBigger || target.blackBishopLower || 
                ...
                target.blackQueen || target.blackPawn1 || target.blackPawn2 || target.blackPawn3
                || target.blackPawn4 || target.blackPawn5 || target.blackPawn6 || target.blackPawn7 
                || target.blackPawn8){
                    return false
            }
        }
