...
export class Queen extends Figure{
    ...
    public canMove(target: Cell){
        if(!super.canMove(target)){
           ...
           console.log(this.cellForKill.cell?.figure?.color, this.figureMainObj.figure?.cell.figure?.color);
            ...
            this.figureMainObj.figure?.color === Color.WHITE) {
                ...
                if(this.figureMainObj.figure.cell.x === this.cellForKill.cell.x && target.figure?.cell === this.figureMainObj.figure?.cell && this.cell === this.cellForKill.cell){
