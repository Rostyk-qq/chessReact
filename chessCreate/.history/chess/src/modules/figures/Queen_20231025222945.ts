...
export class Queen extends Figure{
    ...
    public canBlock(target: Cell){
        if(this.cell.figure?.color === Color.WHITE){
            if(this.cell.moveDiagonalKingDisabledWhite(target) && target.figure){
                target.figure.whiteQueen = true
                return true
            }
            if(this.cell.moveHorizontalKingDisabledWhite(target) && target.figure){
                target.figure!.whiteQueen = true
                return true
            }
        ...
        if(this.cell.figure?.color === Color.BLACK){ 
            ...
            target.figure!.blackQueen = false
            return false
        }
    }
}
