                ...
                target.blockFigureMovementHorizontalQueen(figureMain.figure?.cell, kingBlack)){
                    ...
                    if(Horizontal){
                        if(Horizontal.bool){
                            ...
                            this.cell.cellBlackProtectQueen = Horizontal.cell;
                            this.cell.cellWhiteAttackQueen = figureMain.figure?.cell;
                        }
                        else{
                            if(Horizontal.cell){
                ...
                target.blockFigureMovementHorizontalRook(figureMain.figure?.cell , kingBlack)){
                    ...
                    if(Vertical){
                        if(Vertical.bool){
                            ...
                            this.cell.cellBlackProtectRook = Vertical.cell;
                            this.cell.cellWhiteAttackRook = figureMain.figure?.cell;
                        }
                        else{
                            if(Vertical.cell){
                                Vertical.cell.block = false
                    ...
                    if(Horizontal){
                        if(Horizontal.bool){
                            Horizontal.cell.block = true
                                ...
                                this.cell.cellBlackProtectRook = Horizontal.cell;
                                this.cell.cellBlackProtectRook = figureMain.figure?.cell;
                    ...
                    if(target.blockFigureMovementDiagonalBishop(figureMain.figure?.cell, kingBlack)){
                        ...
                        if(Diagonal){
                            if(Diagonal.bool){
                                ...
                                this.cell.cellBlackProtectBishop = Diagonal.cell
                                this.cell.cellWhiteAttackBishop = figureMain.figure?.cell;
                            }
                            else{ 
                                if(Diagonal.cell){
                                    Diagonal.cell.block = false
