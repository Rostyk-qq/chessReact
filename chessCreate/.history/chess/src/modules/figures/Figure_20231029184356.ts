    ...
    if(target.board.arrayBlackFiguresBlock.length){
        this.cell.board.arrayBlackFiguresBlock.map(figureMain => {
            if(figureMain.figure?.figureName === FigureName.QUEEN || (target.figure?.figureName === FigureName.KING  &&  target.figure.color === Color.WHITE)){
                ...
                if(target.blockFigureMovementDiagonal(figureMain.figure?.cell, figureMain.king) ||
                target.blockFigureMovementBlackKingVertical(figureMain.figure?.cell, figureMain.king) ||
                target.blockFigureMovementBlackKingHorizontal(figureMain.figure?.cell, figureMain.king)){

                    const Diagonal = target.blockFigureMovementBlackKingDiagonal(figureMain.figure?.cell, figureMain.king)
                    const Vertical = target.blockFigureMovementBlackKingVertical(figureMain.figure?.cell, figureMain.king)
                    const Horizontal = target.blockFigureMovementBlackKingHorizontal(figureMain.figure?.cell, figureMain.king)
            ...
            if(figureMain.figure?.figureName === FigureName.ROOK || (target.figure?.figureName === FigureName.KING  &&  target.figure.color === Color.WHITE)){
                if(target.blockFigureMovementBlackKingVertical(figureMain.figure?.cell , figureMain.king) ||
                target.blockFigureMovementBlackKingHorizontal(figureMain.figure?.cell , figureMain.king)){
                    const Vertical = target.blockFigureMovementBlackKingVertical(figureMain.figure?.cell, figureMain.king)
                    const Horizontal = target.blockFigureMovementBlackKingHorizontal(figureMain.figure?.cell, figureMain.king)
            ...
            if(figureMain?.figure?.figureName === FigureName.BISHOP || (target.figure?.figureName === FigureName.KING  &&  target.figure.color === Color.WHITE)){    
                let cell: Result            
                if(target.blockFigureMovementBlackKingDiagonal(figureMain.figure?.cell , figureMain.king)){

                    cell = target.blockFigureMovementBlackKingDiagonal(figureMain.figure?.cell, figureMain.king)!
                    if(cell.bool){
                        cell.cell.block = true
