...
export abstract class Figure{
    ...
    public canMove(target: Cell){
            if(this.cell.color === Color.WHITE && 
               (this.cell.figure?.figureName === FigureName.QUEEN ||
                this.cell.figure?.figureName === FigureName.BISHOP ||
                this.cell.figure?.figureName === FigureName.ROOK)){    
                ...
                if(target.board.arrayWhiteFiguresBlock.length){
                    this.cell.board.arrayWhiteFiguresBlock.map(figureMain => {
                        ...
                        if(figureMain.figure?.figureName === FigureName.QUEEN){
                            if(this.cell.blockFigureMovementWhiteKingDiagonal(figureMain.figure.cell, figureMain.king) ||
                            this.cell.blockFigureMovementWhiteKingVertical(figureMain.figure.cell, figureMain.king) ||
                            this.cell.blockFigureMovementWhiteKingHorizontal(figureMain.figure.cell, figureMain.king)){
                        ...
                        if(figureMain.figure?.figureName === FigureName.BISHOP){
                            if(target.blockFigureMovementWhiteKingDiagonal(figureMain.figure.cell, figureMain.king) ){
                                if(figureMain.figure.uniqValue === 1100){
                                    target.blackBishopLower = false
                                }
                                if(figureMain.figure.uniqValue === 1200){
