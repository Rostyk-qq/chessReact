...
export class King extends Figure{
    ...
    public canMove(target: Cell){
        ...
        if(this.cell.figure?.color === Color.WHITE){
            ...
            if((target.figure?.figureName === FigureName.QUEEN || target.figure?.figureName === FigureName.QUEEN) && target.figure?.color === Color.WHITE
                ){
                if(kingMovementBlackDiagonal(target)){
