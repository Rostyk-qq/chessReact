    ...
    public canMove(target: Cell){
            ...
            if(this.cell.figure?.color === Color.WHITE){    
                        ...
                        if(this.cell.figure?.figureName === FigureName.QUEEN){
                            ...
                            if(this.cell.blockFigureMovementWhiteKingDiagonal(this.cell.figure.cell, this.cell.king) ||
                            this.cell.blockFigureMovementWhiteKingVertical(this.cell.figure.cell, this.cell.king) ||
                            this.cell.blockFigureMovementWhiteKingHorizontal(this.cell.figure.cell, this.cell.king)){
