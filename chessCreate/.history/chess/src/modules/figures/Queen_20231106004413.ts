...
export class Queen extends Figure{
    ...
    public canMove(target: Cell){
        ...
        console.log(this.cell.cellBlackProtectQueen.figure?.color, target.cellWhiteAttackQueen.figure?.color);
            ...
            if ((this.cell.cellBlackProtectQueen.figure?.figureName === FigureName.QUEEN && this.cell.cellBlackProtectQueen.figure?.color === Color.BLACK && this.cellBlackProtectQueen.block) 
