...
export class Knight extends Figure{
    ...
    public canMove(target: Cell){
        ...
        public canBlock(target: Cell){
            ...
            console.log(this.thisCell?.y, this.cell.x);
            ...
            if(this.cell.figure?.color === Color.WHITE){
                ...
                else if((this.thisCell?.x === this.cell.x - 1 || this.thisCell?.x === this.cell.x - 2) && 
                (this.thisCell?.y === this.cell.y - 1 || this.thisCell?.y === this.cell.y - 2)){
