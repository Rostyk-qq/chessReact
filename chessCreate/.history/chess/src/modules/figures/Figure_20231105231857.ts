...
export abstract class Figure{
    ...
    cellBlackProtectQueen: Cell | null;
    cellWhiteAttackQueen: Cell | null

    cellBlackProtectRook: Cell | null
    cellWhiteAttackRook: Cell | null

    cellBlackProtectBishop: Cell | null
    cellWhiteAttackBishop: Cell | null
    ...
    constructor(color: Color, cell: Cell, uniqValue: number | null ) {
        ...
        this.cellBlackProtectQueen = null;
        this.cellWhiteAttackQueen = null;

        this.cellBlackProtectRook = null;
        this.cellWhiteAttackRook = null;

        this.cellBlackProtectBishop = null;
        this.cellWhiteAttackBishop = null;
    }
                ...
                target.blockFigureMovementHorizontalQueen(figureMain.figure?.cell, kingBlack)){
                    ...
                    if(Diagonal){
                        if(Diagonal.bool){
                            ...
                            this.cellBlackProtectQueen = Diagonal.cell;
                            this.cellWhiteAttackQueen = figureMain.figure?.cell;
                        }
                        else{ 
                            if(Diagonal.cell){
                    ...
                    if(Vertical){
                        if(Vertical.bool){
                            ...
                            this.cellBlackProtectQueen = Vertical.cell;
                            this.cellWhiteAttackQueen = figureMain.figure?.cell;
                        }
                        else{
                            if(Vertical.cell){
                    ...
                    if(Horizontal){
                        if(Horizontal.bool){
                            ...
                            this.cellBlackProtectQueen = Horizontal.cell;
                            this.cellWhiteAttackQueen = figureMain.figure?.cell;
                        }
                        else{
                            if(Horizontal.cell){
                ...
                target.blockFigureMovementHorizontalRook(figureMain.figure?.cell , kingBlack)){
                    ...
                    if(Vertical){
                        if(Vertical.bool){
                            ...
                            this.cellBlackProtectRook = Vertical.cell;
                            this.cellWhiteAttackRook = figureMain.figure?.cell;
                        }
                        else{
                            if(Vertical.cell){
                                Vertical.cell.block = false
                    ...
                    if(Horizontal){
                        if(Horizontal.bool){
                            ...
                            this.cellBlackProtectRook = Horizontal.cell;
                            this.cellWhiteAttackRook = figureMain.figure?.cell;
                        }
                        else{
                            if(Horizontal.cell){
                    ...
                    if(target.blockFigureMovementDiagonalBishop(figureMain.figure?.cell, kingBlack)){
                        ...
                        if(Diagonal){
                            if(Diagonal.bool){
                                ...
                                this.cellBlackProtectBishop = Diagonal.cell
                                this.cellWhiteAttackBishop = figureMain.figure?.cell;
                            }
                            else{ 
                                if(Diagonal.cell){
                                    Diagonal.cell.block = false
    ...
    //                         this.cellForKill = Diagonal
    //                         this.figureMainObj = figureMain
    //                     }
    //                     else{ 
    //                         if(Diagonal.cell){
    //                             Diagonal.cell.block = false
    ...
    // if ((this.figureMainObj.figure?.figureName === FigureName.QUEEN && this.figureMainObj.figure?.color === Color.BLACK) && 
    // this.cellForKill.cell?.figure?.color === Color.WHITE) {
        
    //     if(this.figureMainObj.figure.cell.x === this.cellForKill.cell.x){
    //         if(this.figureMainObj.figure.cell.VerticalKill(this.figureMainObj.figure.cell, this.cellForKill.cell)){
    //             return true
    //         }
    //         return false
    //     }
