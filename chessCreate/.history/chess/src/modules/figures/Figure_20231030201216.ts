...
export abstract class Figure{
    ...
    if(target.board.arrayWhiteFiguresBlock.length){
        ...
        this.cell.board.arrayWhiteFiguresBlock.map(figureMain => {
            console.log(figureMain.king);
                if(target.figure?.figureName === FigureName.QUEEN && target.figure?.color === Color.WHITE && (target.blockFigureMovementDiagonalBlackKing(figureMain.figure?.cell, figureMain.king) ||
                ...
                if((figureMain.figure?.figureName === FigureName.ROOK && figureMain.figure?.color === Color.WHITE) && (target.blockFigureMovementVerticalBlackKing(figureMain.figure?.cell , figureMain.king) ||
                target.blockFigureMovementHorizontalBlackKing(figureMain.figure?.cell , figureMain.king))){
                    const Vertical = target.blockFigureMovementVerticalBlackKing(figureMain.figure?.cell, figureMain.king)
                    const Horizontal = target.blockFigureMovementHorizontalBlackKing(figureMain.figure?.cell, figureMain.king)
                ...
                if((figureMain.figure?.figureName === FigureName.BISHOP && figureMain.figure?.color === Color.WHITE) && target.blockFigureMovementDiagonalBlackKing(figureMain.figure?.cell , figureMain.king)){
                    const cell = target.blockFigureMovementDiagonalBlackKing(figureMain.figure?.cell, figureMain.king)!
                    if(cell.bool){
