...
export class Knight extends Figure{
    ...
    public canBlock(target: Cell){
            ...
            if(this.cell.figure?.color === Color.WHITE){
                if((Math.abs(target.x - this.cell.x) === 1 && Math.abs(target.y - this.cell.y) === 2) || (Math.abs(target.x - this.cell.x) === 2 && dy === 1)){
            ...
            if(this.cell.figure?.color === Color.BLACK){
                if(((Math.abs(target.x - this.cell.x) === 1 && Math.abs(target.y - this.cell.y) === 2) || (Math.abs(target.x - this.cell.x) === 2 && Math.abs(target.y - this.cell.y) === 1))){
