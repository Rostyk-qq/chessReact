...
export class Queen extends Figure{
    ...
    public canMove(target: Cell){
        ...
        console.log(this.cell.figure?.cellBlackProtectQueen.figure, target.figure?.cellWhiteAttackQueen.figure);
            ...
            if ((this.cell.figure?.cellBlackProtectQueen.figure?.figureName === FigureName.QUEEN 
                ...
                && target.figure?.cellWhiteAttackQueen.figure?.color === Color.WHITE &&  ) {
