...
export abstract class Figure{
    ...
    if(target.board.arrayWhiteFiguresBlock.length){
        ...
        if(this.cell.block){
            ...
            this.cell.board.arrayWhiteFiguresKingMovement.map(cell => {
                
            })
            if(this.cell.figure?.color === Color.BLACK && target.figure?.color === Color.WHITE && (this.cell.x === target.x || this.cell.x === target.x || dx === dy)){
