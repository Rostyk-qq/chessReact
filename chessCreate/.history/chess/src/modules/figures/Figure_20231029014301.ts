...
export abstract class Figure{
    ...
    public canMove(target: Cell){
        ...
        public canMove(target: Cell) {
            let cellForKill: Result | undefined = undefined;
            let figureMainObj: FigureBlock | undefined = undefined;
          
            if (target.board.arrayWhiteFiguresBlock.length) {
              this.cell.board.arrayWhiteFiguresBlock.map((figureMain) => {
                if (
                  figureMain.figure?.figureName === FigureName.QUEEN ||
                  (target.figure?.figureName === FigureName.KING && target.figure.color === Color.BLACK)
                ) {
                  if (
                    target.blockFigureMovementWhiteKingDiagonal(figureMain.figure?.cell, figureMain.king) ||
                ...
                if (
                  figureMain.figure?.figureName === FigureName.ROOK ||
                  (target.figure?.figureName === FigureName.KING && target.figure.color === Color.BLACK)
                ) {
                  if (
                    target.blockFigureMovementWhiteKingVertical(figureMain.figure?.cell, figureMain.king) ||
                ...
                if (
                  figureMain?.figure?.figureName === FigureName.BISHOP ||
                  (target.figure?.figureName === FigureName.KING && target.figure.color === Color.BLACK)
                ) {
                  let cell: Result;
            ...
            if (figureMainObj && cellForKill) {
              ...
              if (
                ...
                target.figure?.color === Color.WHITE &&
                (target.x === figureMainObj.king.x || target.y === figureMainObj.king.y || dx === dy)
              ) {
                return true;
              }
            }
