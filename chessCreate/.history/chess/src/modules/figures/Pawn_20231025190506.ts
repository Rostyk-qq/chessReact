...
export class Pawn extends Figure{
    ...
    if(target.color === Color.WHITE && whiteQueen){
        ...
        if(this.cell.figure?.color === Color.WHITE && this.cell.figure?.figureName === FigureName.PAWN && target.figure?.color === Color.BLACK && target.figure?.figureName === FigureName.QUEEN){                
