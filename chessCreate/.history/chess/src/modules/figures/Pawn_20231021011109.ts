...
export class Pawn extends Figure{
   ...
   public canBlock(target: Cell){
    if(this.cell.figure?.color === Color.WHITE && this.cell.figure?.figureName === FigureName.PAWN && target.x !== this.cell.x && target.y !== this.cell.y){
    ...
    if(this.cell.figure?.color === Color.BLACK && this.cell.figure?.figureName === FigureName.PAWN && target.x !== this.cell.x && target.y !== this.cell.y){
        const stepOne = this.cell.figure?.color === Color.BLACK ? 1 : -1
