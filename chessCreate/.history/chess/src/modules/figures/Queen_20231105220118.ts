...
export class Queen extends Figure{
    ...
    public canMove(target: Cell){
        if(!super.canMove(target)){
           ...
           console.log(this.cellForKill.cell, this.figureMainObj.figure?.cell);
           
            if ((this.cellForKill.cell?.figure?.figureName === FigureName.QUEEN && this.cellForKill.cell?.figure?.color === Color.BLACK) && 
            this.figureMainObj.cell?.figure?.color === Color.WHITE) {
                console.log(target.figure?.cell === this.cellForKill.cell && this.cell.figure.cell === this.figureMainObj.figure.cell);
                
                if(this.figureMainObj.figure.cell.x === this.cellForKill.cell.x && target.figure?.cell === this.cellForKill.cell && this.cell === this.figureMainObj.figure.cell){
