...
export abstract class Figure{
    ...
    public canMove(target: Cell){
        ...
        &&
        ((this.cell?.y === 7 && this.cell.figure?.cell.x === 0) && (target.figure?.cell.y === 0 && target.figure?.cell.x === 3)) || 
        ((this.cell?.y === 7 && this.cell.figure?.cell.x === 7) && (target.figure?.cell.y === 0 && target.figure?.cell.x === 3)) || 
