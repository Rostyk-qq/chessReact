...
export abstract class Figure{
    ...
    cellWhiteProtectQueen: Cell;
    cellBlackAttackQueen: Cell

    cellWhiteProtectRook: Cell
    cellBlackAttackRook: Cell

    cellWhiteProtectBishop: Cell
    cellBlackAttackBishop: Cell
    ...
    constructor(color: Color, cell: Cell, uniqValue: number | null ) {
        ...
        this.cellWhiteProtectQueen = this.cell;
        this.cellWhiteAttackQueen = this.cell;

        this.cellWhiteProtectRook = this.cell;
        this.cellWhiteAttackRook = this.cell;

        this.cellWhiteProtectBishop = this.cell;
                    ...
                    if(Horizontal){
                        if(Horizontal.bool){
                            Horizontal.cell.block = true
                                ...
                                this.cellBlackProtectRook = figureMain.figure?.cell;
