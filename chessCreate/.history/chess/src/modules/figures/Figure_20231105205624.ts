...
export abstract class Figure{
    ...
    constructor(color: Color, cell: Cell, uniqValue: number | null ) {
        ...
        this.cellForKill = {cell: null, bool: false};
        this.figureMainObj = {figure: null, king: {x: 0, y: 0}};
    }
    ...
    this.cellForKill.cell?.figure?.color === Color.WHITE) {
        ...
        if(this.figureMainObj.figure.cell.x === this.cellForKill.cell.x){
            ...
            if(this.figureMainObj.figure.cell.HorizontalKill(this.figureMainObj.figure.cell, this.cellForKill.cell)){
                return false
            }
            if(this.figureMainObj.figure.cell.DiagonalKill(this.figureMainObj.figure.cell, this.cellForKill.cell)){
                return false
            }
            return false
        }
