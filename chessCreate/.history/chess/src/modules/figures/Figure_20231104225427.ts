    ...
    if(target.board.arrayBlackFiguresBlock.length){
        this.cell.board.arrayBlackFiguresBlock.map(figureMain => {
            ...
            if(figureMain.figure?.figureName === FigureName.QUEEN || this.cell){
                ...
                if(target.blockFigureMovementDiagonalBlack(figureMain.figure?.cell, kingWhite) ||
                target.blockFigureMovementVerticalBlack(figureMain.figure?.cell, kingWhite) ||
                target.blockFigureMovementHorizontalBlack(figureMain.figure?.cell, kingWhite)){

                    let Diagonal = target.blockFigureMovementDiagonalBlack(figureMain.figure?.cell, kingWhite)
                    let Vertical = target.blockFigureMovementVerticalBlack(figureMain.figure?.cell, kingWhite)
                    let Horizontal = target.blockFigureMovementHorizontalBlack(figureMain.figure?.cell, kingWhite)
            ...
            if(figureMain.figure?.figureName === FigureName.ROOK || this.cell){
                ...
                if(target.blockFigureMovementVerticalBlack(figureMain.figure?.cell, kingWhite) ||
                target.blockFigureMovementHorizontalBlack(figureMain.figure?.cell, kingWhite)){
                    const Vertical = target.blockFigureMovementVerticalBlack(figureMain.figure?.cell, kingWhite)
                    const Horizontal = target.blockFigureMovementHorizontalBlack(figureMain.figure?.cell, kingWhite)
            ...
            if(figureMain?.figure?.figureName === FigureName.BISHOP || this.cell){    
                if(target.blockFigureMovementDiagonalBlack(figureMain.figure?.cell , kingWhite)){
                    ...
                    const Diagonal = target.blockFigureMovementDiagonalBlack(figureMain.figure?.cell, kingWhite)
