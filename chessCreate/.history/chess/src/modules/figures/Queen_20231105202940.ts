           ...
           return false 
            ...
            this.cellForKill.cell?.figure?.color === Color.WHITE) {
                ...
                if(this.figureMainObj.figure.cell.x === this.cellForKill.cell.x){
                    if(this.figureMainObj.figure.cell.moveVertical(this.cellForKill.cell)){
                        return true
                    }
                    if(this.figureMainObj.figure.cell.moveHorizontal(this.cellForKill.cell)){
                        return false
                    }
                    if(this.figureMainObj.figure.cell.moveDiagonal(this.cellForKill.cell)){
                        return true
                    }
                }
                return false
