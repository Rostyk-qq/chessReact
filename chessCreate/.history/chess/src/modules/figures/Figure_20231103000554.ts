    ...
    if(target.board.arrayWhiteFiguresBlock.length){
        this.cell.board.arrayWhiteFiguresBlock.map(figureMain => {
            if(figureMain.figure?.figureName === FigureName.QUEEN && this.cell.figure && (target.figure?.figureName === FigureName.KING  &&  target.figure.color === Color.BLACK)){ 
                ...
                target.blockFigureMovementVertical(figureMain.figure?.cell, {x: target.x, y: target}}) ||
                target.blockFigureMovementHorizontal(figureMain.figure?.cell, figureMain.king)){
                    ...
                    let Vertical = target.blockFigureMovementVertical(figureMain.figure?.cell, figureMain.king)
