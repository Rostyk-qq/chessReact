...
export class Queen extends Figure{
    ...
    public canMove(target: Cell){
        ...
        console.log(this.cell.cellBlackProtectQueen.figure?.color, this.yathey  .cellWhiteAttackQueen.figure?.color);
        
            if ((this.cellBlackProtectQueen.figure?.figureName === FigureName.QUEEN && this.cellBlackProtectQueen.figure?.color === Color.BLACK && this.cellBlackProtectQueen.block) 
