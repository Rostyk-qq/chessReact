...
export class Bishop extends Figure{
    ...
    public canBlock(target: Cell){
            if(this.cell.figure?.color === Color.WHITE && this.cell.figure?.figureName === FigureName.BISHOP){
            ...
            if(this.cell.figure?.color === Color.BLACK && this.cell.figure?.figureName === FigureName.BISHOP){ 
