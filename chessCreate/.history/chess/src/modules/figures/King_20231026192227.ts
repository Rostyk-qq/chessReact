...
export class King extends Figure{
    ...
    public canMove(target: Cell){
        ...
        if(this.cell.figure?.color === Color.WHITE){
            ...
            if((this.cell.figure?.figureName === FigureName.QUEEN || this.cell.figure?.figureName === FigureName.BISHOP) && this.cell.figure?.color === Color.WHITE){
                console.log('Inside!');
                
                if(this.cell.kingMovementBlackDiagonal(this.cell)){
                    return true
                }
            }
