...
export class Pawn extends Figure{
    ...
    public canBlock(target: Cell){
        if((this.cell.figure?.color === Color.WHITE && target.figure.figureName === FigureName.PAWN) && (target.figure?.color === Color.BLACK && target.figure.figureName === FigureName.PAWN)){                
