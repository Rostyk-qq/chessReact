        ...
        blockBlackFigureDiagonal(cell: Cell, blackKing: XY){
            ...
            for (let i = 1; i <= dy; i++) {
                if(!this.board.getCell(this.y + (i * directionY), this.x + (i * directionX)).isEmpty()){
                    ...
                    && this.board.getCell(this.y + (i * directionY), this.x + (i * directionX)).figure?.figureName === Color.BLACK){
                        figure = this.board.getCell(this.y + (i * directionY), this.x + (i * directionX))
                        i++
                    }
                }
            }
