...
export class Cell{
        ...
        deletedDiagonal: Cell | null
        counterDiagonal: number

        deletedVertical: Cell | null
        counterVertical: number

        deletedHorizontal: Cell | null
        counterHorizontal: number


        deletedDiagonalBlack: Cell | null
        counterDiagonalBlack: number

        deletedVerticalBlack: Cell | null
        counterVerticalBlack: number

        deletedHorizontalBlack: Cell | null
        counterHorizontalBlack: number
        ...
        constructor(board: Board, y: number, x: number,color: Color, figure: Figure | null){
            ...
            this.deletedDiagonalBlack = null
            this.counterDiagonalBlack = 0

            this.deletedVerticalBlack = null
            this.counterVerticalBlack = 0
    
            this.deletedHorizontalBlack = null
            this.counterHorizontalBlack = 0
        ...
        moveFigure(target: Cell){
            ...
            blockFigureMovementDiagonal(figure: Cell, king: XY){
                ...
                if(figure && this.counterDiagonal === 1){
            ...
            blockFigureMovementDiagonalBlack(figure: Cell, king: XY){
                this.counterDiagonalBlack = this.counterDiagonalBlack + 1
                if(figure && this.counterDiagonalBlack === 1){
                   this.deletedDiagonalBlack = figure   
                }
                ...
                if(arrayFigures.length === 3 && dx === dy && this.deletedDiagonalBlack === arrayFigures[2]){
                    this.cellDiagonal = arrayFigures[0]
                    this.deletedDiagonalBlack = null
                    this.counterDiagonalBlack = 0
                    return {cell: arrayFigures[0], bool: true}
            ...
            blockFigureMovementVerticalBlack(figure: Cell, king: XY){
                this.counterVerticalBlack = this.counterVerticalBlack + 1
                if(this.counterVerticalBlack === 1){
                    this.deletedVerticalBlack = figure
                }
                let item: Cell;
                let arrayCell: Array<Cell> = [];
                ...
                for (let i = 1; i <= dy; i++) {
                    if(!this.board.getCell(figure.y + (i * directionY), figure.x).isEmpty()){
                        if(this.board.getCell(figure.y + (i * directionY), figure.x).figure?.color === figure.figure?.color){
                            return {cell: this.cellVerticalBlack!, bool: false}
                        }
                        item = this.board.getCell(figure.y + (i * directionY), figure.x)
                        arrayCell.push(item)
                    }
                ...
                if(arrayCell.length === 3 && figure.x === king.x && this.deletedVerticalBlack === arrayCell[2]){
            ...
            blockFigureMovementHorizontalBlack(figure: Cell, king: XY){
                this.counterHorizontalBlack = this.counterHorizontalBlack + 1
                if(this.counterHorizontalBlack === 1){
                    this.deletedHorizontalBlack = figure
                }
                let item: Cell;
                let arrayCell: Array<Cell> = [];
                ...
                if(arrayCell.length === 3 && figure.y === king.y && this.deletedHorizontalBlack === arrayCell[2]){
