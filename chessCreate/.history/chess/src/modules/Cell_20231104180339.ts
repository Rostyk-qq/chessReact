...
export class Cell{
        ...
        constructor(board: Board, y: number, x: number,color: Color, figure: Figure | null){
            ...
            this.deletedVertical: Cell | null
            this.counterVertical: number
    
            this.deletedHorizontal: Cell | null
            this.counterHorizontal: number
        ...
        moveFigure(target: Cell){
            ...
            blockFigureMovementDiagonal(figure: Cell, king: XY){
                ...
                if(arrayFigures.length === 3 && dx === dy && this.deleted === arrayFigures[2]){
