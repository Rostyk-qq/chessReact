        ...
        moveFigure(target: Cell){
            ...
            DiagonalKill(start: Cell, king: XY, end: Cell){
                ...
                for(let i = 1; i <= dx; i++){
                    ...
                    && this.board.getCell(king.y, king.x) < this.board.getCell(start.y + (i * directionY), start.x + (i * directionX))
                    && this.board.getCell(start.y + (i * directionY), start.x + (i * directionX)) < this.board.getCell(king.y, king.x)){
                        return true
                    }
                }
                return false        
