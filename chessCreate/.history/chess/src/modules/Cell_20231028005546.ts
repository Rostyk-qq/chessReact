...
export class Cell{
        ...
        blockFigureMovementWhiteKingDiagonal(figure: Cell, king: XY){
            ...
            for (let i = 1; i < dy; i++) {
                if(!this.board.getCell(figure.y + (i * directionY), this.x + (i * directionX)).isEmpty()){
                    if(this.board.getCell(figure.y + (i * directionY), this.x + (i * directionX)).figure?.figureName !== FigureName.KING 
                    || this.board.getCell(figure.y + (i * directionY), this.x + (i * directionX)).figure?.color === Color.BLACK){
                        this.board.getCell(figure.y + (i * directionY), this.x + (i * directionX)).block = true
                        return true
                    }
                }
            }
            ...
            for (let i = min + 1; i < max; i++) {
                if(!this.board.getCell(i, this.x).isEmpty()){
                    ...
                    || this.board.getCell(i, figure.x).figure?.color === Color.BLACK){
                        this.board.getCell(i, figure.x).block = true
                        return true
                    }
                }
            }
            ...
            for (let i = min + 1; i < max; i++) {
                if(!this.board.getCell(this.y, i).isEmpty()){
                    ...
                    || this.board.getCell(figure.y, i).figure?.color === Color.BLACK){
                        this.board.getCell(figure.y, i).block = false
                        return true
                    }
                }
            }
