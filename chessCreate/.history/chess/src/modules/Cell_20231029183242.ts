...
export class Cell{
        ...
        blockFigureMovementBlackKingDiagonal(figure: Cell, king: XY){
            const dx = Math.abs(figure.x - king.x);
            const dy = Math.abs(figure.y - king.y);
        ...
        blockFigureMovementBlackKingVertical(figure: Cell, king: XY){
            let item: Cell;
            const arrayCell: Array<Cell> = [];
        ...
        blockFigureMovementBlackKingHorizontal(figure: Cell, king: XY){
            let item: Cell;
            const arrayCell: Array<Cell> = [];
