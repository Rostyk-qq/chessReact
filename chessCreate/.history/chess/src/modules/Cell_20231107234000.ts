...
export class Cell{
        ...
        moveFigure(target: Cell){
            ...
            DiagonalKill(start: Cell, king: XY, end: Cell){
                ...
                for(let i = 1; i <= dx; i++){
                    ...
                    && this.board.getCell(king.y, king.x).x < this.board.getCell(start.y + (i * directionY), start.x + (i * directionX)).x
                    && this.board.getCell(start.y + (i * directionY), start.x + (i * directionX)).x < this.board.getCell(end.y, end.x).x){
                        return true
                    }
                }
                return false        
