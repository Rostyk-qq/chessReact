            ...
            for (let j = 0; j < row.length; j++) {
                ...
                if(!!target?.figure?.canBlock(cell) && target.figure.color === Color.WHITE){
                    ...
                    if(target.figure.figureName === FigureName.ROOK){
                        target.whiteRook = !!target?.figure?.canBlock(target)!
                    }
                    if(target.figure.figureName === FigureName.PAWN){
                        target.whitePawn = !!target?.figure?.canBlock(target)!
                    }
                    if(target.figure.figureName === FigureName.KNIGHT){
                        target.whiteKnight = !!target?.figure?.canBlock(target)!
                    }
                }
                if(!!target?.figure?.canBlock(cell) && target.figure.color === Color.BLACK){
                    if(target.figure.figureName === FigureName.QUEEN){
                        target.blackQueen = !!target?.figure?.canBlock(target)!
                    }
                    if(target.figure.figureName === FigureName.BISHOP){
                        target.blackBishop = !!target?.figure?.canBlock(target)!
                    }
                    if(target.figure.figureName === FigureName.ROOK){
                        target.blackRook = !!target?.figure?.canBlock(target)!
                    }
                    if(target.figure.figureName === FigureName.PAWN){
                        target.blackPawn = !!target?.figure?.canBlock(target)!
                    }
                    if(target.figure.figureName === FigureName.KNIGHT){
                        target.blackKnight = !!target?.figure?.canBlock(ctargetell)!
                    }
                }
            }
        }
