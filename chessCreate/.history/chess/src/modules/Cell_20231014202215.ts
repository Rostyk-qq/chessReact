...
import { Rook } from "./figures/Rook"
    ...
    export class Cell{
        ...
        Castling(clicked: Cell, current: Cell){
            const rook = new Rook(clicked.figure?.color!, this.board.getCell(clicked.y, clicked.x));
            const king = new Rook(current.figure?.color!, this.board.getCell(current.y, current.x));
            rook === 
            setTimeout(() => {
