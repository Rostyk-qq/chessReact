            ...
            for (let i = 1; i <= dy; i++) {
                if(!this.board.getCell(this.y + (i * directionY), this.x + (i * directionX)).isEmpty()){
                    if(this.board.getCell(this.y + (i * directionY), this.x + (i * directionX)).figure?.color === Color.BLACK){
                        this.board.getCell(this.y + (i * directionY), this.x + (i * directionX))?.figure?.block = true
                        return true
                    }
                }
            }
            this.board.getCell(this.y + (i * directionY), this.x + (i * directionX)).figure?.block = false
            return false;
        }
