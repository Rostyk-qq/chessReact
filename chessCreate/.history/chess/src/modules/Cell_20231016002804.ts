...
import { Rook } from "./figures/Rook"
    ...
    export class Cell{
        ...
        whiteKingKill(cell: Cell, kingParams: XY, blackKing: Cell | null, dxDy: XY | null){
            if(cell.figure?.figureName === FigureName.QUEEN){
                if(this.tryToKillKingHorizontal(cell, kingParams, blackKing, dxDy) || this.tryToKillKingDiagonal(cell, kingParams, blackKing) || this.tryToKillKingVertical(cell, kingParams, blackKing)){
                    return true;
                }
            }
            if(cell.figure?.figureName === FigureName.BISHOP){
