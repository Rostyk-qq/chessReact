    ...
    export class Cell{
        ...
        blackKingKill(cell: Cell, kingParams: XY, whiteKing: Cell | null, dxDy: XY | null){
            if(cell.figure?.figureName === FigureName.QUEEN){
                if(this.tryToKillKingHorizontal(cell, kingParams) || this.tryToKillKingDiagonal(cell, kingParams, whiteKing, dxDy) || this.tryToKillKingVertical(cell, kingParams, whiteKing, dxDy)){
                    return true;
                }
            }
