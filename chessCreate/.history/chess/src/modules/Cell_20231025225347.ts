...
export class Cell{
        ...
        setDeletedFigures(target: Figure){
            ...
            target.cell.whiteKing = false
            target.cell.blackKing = false

            target.cell.whiteRookLower = false
            target.cell.blackRookLower = false
            target.cell.whiteRookBigger = false
            target.cell.blackRookBigger = false

            target.cell.whiteBishopLower = false
            target.cell.blackBishopLower = false
            target.cell.whiteBishopBigger = false
            target.cell.blackBishopBigger = false

            target.cell.whiteKnightLower = false
            target.cell.whiteKnightBigger = false
            target.cell.blackKnightLower = false
            target.cell.blackKnightBigger = false

            target.cell.whitePawn = [false, false, false, false, false, false, false, false];
            target.cell.blackPawn = [false, false, false, false, false, false, false, false];
