...
export class Cell{
        ...
        moveFigure(target: Cell){
            ...
            DiagonalKill(start: Cell, end: Cell){
                    ...
                    const dyQueen = start.y - this.figure?.cellWhiteAttack.cell.y!;Math.abs(start.x - this.figure?.cellWhiteAttack.cell.x!);
                    ...
                    console.log(start.x > this.figure?.cellWhiteAttack.cell.x! && ((dxQueen < 0 && dyQueen > 0) || (dxQueen > 0 && dyQueen < 0)));
