...
export class Cell{
        ...
        blockFigureMovementDiagonalBlackKing(figure: Cell, king: Cell){
        ...
        blockFigureMovementVerticalBlackKing(figure: Cell, king: Cell){
            let item: Cell;
        ...
        blockFigureMovementHorizontalBlackKing(figure: Cell, king: Cell){
            let item: Cell;
            const arrayCell: Array<Cell> = [];
