        ...
        if(cell.figure?.color === Color.WHITE){
            ...
            for (let i = 0; i < dy; i++) {
                if(!this.board.getCell(cell.y + (i * directionY), cell.x + (i * directionX)).isEmpty()){
                    if(this.board.getCell(cell.y + (i * directionY), cell.x + (i * directionX)).figure?.color === Color.BLACK 
                    && this.board.getCell(cell.y + (i * directionY), cell.x + (i * directionX)).figure?.figureName === FigureName.KING){
                        return true
                    }
                    return false
                } 
