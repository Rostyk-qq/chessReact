        ...
        for (let i = 0; i < this.cells.length; i++) {
            ...
            for (let j = 0; j < row.length; j++) {
                ...
                if(!!target?.figure?.canBlock(cell) && target.figure.color === Color.WHITE){
                    ...
                    if(target.figure.figureName === FigureName.KNIGHT && target.figure.cell.x === 1 && target.figure.cell.y === 7){
                        target.whiteKnight = !!target?.figure?.canBlock(cell)!
                    }
                    if(target.figure.figureName === FigureName.KNIGHT && target.figure.cell.x === 6 && target.figure.cell.y === 7){
                        target.whiteKnight = !!target?.figure?.canBlock(cell)!
                    }
