...
import { Rook } from "./figures/Rook"
    ...
    export class Cell{
        ...
        Castling(clickedFigure: Figure | null, currentFigure: Figure | null){
            const rook = new Rook(clickedFigure?.color, this.board.getCell(clickedFigure?.cell.y, clickedFigure?.cell.x))
        }
        biggerCastling(clickedFigure: Figure | null, currentFigure: Figure | null) {
