...
export class Cell{
        ...
        constructor(board: Board, y: number, x: number,color: Color, figure: Figure | null){
            ...
            this.whiteRookLower = true
            this.blackRookLower = true
            this.whiteRookBigger = true
            this.blackRookBigger = true

            this.whiteBishopLower = true
            this.blackBishopLower = true
            this.whiteBishopBigger = true
            this.blackBishopBigger = true

            this.whiteKnightLower = true
            this.whiteKnightBigger = true
            this.blackKnightLower = true
            this.blackKnightBigger = true

            this.whitePawn = [true, true, true, true, true, true, true, true];
            this.blackPawn = [true, true, true, true, true, true, true, true];
        }
        ...
        moveFigure(target: Cell){
            ...
            blockFigureMovementDiagonal(figure: Cell, king: XY){
                ...
                if(arrayFigures.length === 3 && dx === dy){
