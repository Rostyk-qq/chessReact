...
export class Cell{
        ...
        blockFigureMovementDiagonal(figure: Cell, king: XY){
            ...
            let item: Cell, returnItemFalse: Cell = figure;
            ...
            if(dx === dy){
                ...
                returnItemFalse = newArray[0]

                if(arrayFigures.length === 2 && kingCell){
                    console.log('{cell: newArray[0], bool: true}');
                ...
                console.log('{cell: newArray[0], bool: false}', returnItemFalse);
                return {cell: returnItemFalse, bool: false}
            }
        }
