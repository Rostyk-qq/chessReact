    ...
    export class Cell{
        ...
        blackKingKill(cell: Cell, kingParams: XY, king: Cell | null){
            ...
            if(cell.figure?.figureName === FigureName.ROOK){
                if(this.tryToKillKingHorizontal(cell, kingParams) || this.tryToKillKingVertical(cell, kingParams, king)){
                    return true
                }
            }
        }
        ...
        whiteKingKill(cell: Cell, kingParams: XY, king: Cell | null){
            if(cell.figure?.figureName === FigureName.QUEEN){
                if(this.tryToKillKingHorizontal(cell, kingParams) || this.tryToKillKingDiagonal(cell, kingParams, king) || this.tryToKillKingVertical(cell, kingParams, king)){
                    return true;
                }
            }
            if(cell.figure?.figureName === FigureName.BISHOP){
