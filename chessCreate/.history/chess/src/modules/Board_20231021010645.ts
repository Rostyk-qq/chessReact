        ...
        for (let i = 0; i < this.cells.length; i++) {
            ...
            for (let j = 0; j < row.length; j++) {
                ...
                if(!!target?.figure?.canBlock(cell) && target.figure.color === Color.WHITE){
                    if(target.figure.figureName === FigureName.QUEEN && cell.x === target.x && cell.y === target.y){
                        target.whiteQueen = !!target?.figure?.canBlock(cell)!
                    }
                    if(target.figure.figureName === FigureName.BISHOP && cell.x === target.x && cell.y === target.y){
                        target.whiteBishop = !!target?.figure?.canBlock(cell)!
                    }
                    if(target.figure.figureName === FigureName.ROOK && cell.x === target.x && cell.y === target.y){
                        target.whiteRook = !!target?.figure?.canBlock(cell)!
                    }
                    if(target.figure.figureName === FigureName.PAWN && cell.x === target.x && cell.y === target.y){
                        target.whitePawn = !!target?.figure?.canBlock(cell)!
                    }
                    if(target.figure.figureName === FigureName.KNIGHT && cell.x === target.x && cell.y === target.y){
                        target.whiteKnight = !!target?.figure?.canBlock(cell)!
                    }
                }
                if(!!target?.figure?.canBlock(cell) && target.figure.color === Color.BLACK){
                    if(target.figure.figureName === FigureName.QUEEN && cell.x === x && cell.y === y){
                        target.blackQueen = !!target?.figure?.canBlock(cell)!
                    }
                    if(target.figure.figureName === FigureName.BISHOP && cell.x === x && cell.y === y){
                        target.blackBishop = !!target?.figure?.canBlock(cell)!
                    }
                    if(target.figure.figureName === FigureName.ROOK && cell.x === x && cell.y === y){
                        target.blackRook = !!target?.figure?.canBlock(cell)!
                    }
                    if(target.figure.figureName === FigureName.PAWN && cell.x === x && cell.y === y){
                        target.blackPawn = !!target?.figure?.canBlock(cell)!
                    }
                    if(target.figure.figureName === FigureName.KNIGHT && cell.x === x && cell.y === y){
                        target.blackKnight = !!target?.figure?.canBlock(cell)!
                    }
                }
            }
        }
