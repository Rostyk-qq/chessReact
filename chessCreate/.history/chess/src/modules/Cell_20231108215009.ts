...
export class Cell{
        ...
        moveFigure(target: Cell){
            ...
            DiagonalKill(start: Cell, end: Cell){
                    ...
                    const dxL = Math.abs(start.x - end.x);
                    const dyL = Math.abs(start.y - end.y);
                    ...
                    console.log(this.figure?.cellWhiteAttack.cell.x! < start.x && ((dxL * directionXL <= 0 && dyL * directionYL >= 0) || (dxL * directionXL >= 0 && dyL * directionYL <= 0)));
                    
                    if(this.figure?.cellWhiteAttack.cell.x! < start.x && ((dxL * directionXL <= 0 && dyL * directionYL >= 0) || (dxL * directionXL >= 0 && dyL * directionYL <= 0))){
