...
export class Cell{
        ...
        blockFigureMovementVerticalBlackKing(figure: Cell, king: XY){
            ...
            for (let i = min; i < max; i++) {
                if(!this.board.getCell(i * directionY, figure.x * directionX).isEmpty()){
                    item = this.board.getCell(i * directionY, figure.x * directionX)
                    arrayCell.push(item)
                }    
            }
        ...
        blockFigureMovementHorizontalBlackKingLeft(figure: Cell, king: XY){
            let item: Cell;
            const arrayCell: Array<Cell> = [];
        ...
        blockFigureMovementHorizontalBlackKingRight(figure: Cell, king: XY){
            let item: Cell;
            const arrayCell: Array<Cell> = [];
        ...
        blockFigureMovementHorizontalWhiteKingRight(figure: Cell, king: XY){
            let item: Cell;
            const arrayCell: Array<Cell> = [];
        ...
        blockFigureMovementHorizontalWhiteKingLeft(figure: Cell, king: XY){
            let item: Cell;
            const arrayCell: Array<Cell> = [];
