        ...
        moveFigure(target: Cell){
            ...
            DiagonalKill(start: Cell, end: Cell){
                ...
                for(let i = 1; i <= dx; i++){
                    ...
                    (Math.abs(this.board.getCell(start.y + (i * directionY), start.x  + (i * directionX)).y - end.y) === Math.abs(this.board.getCell(start.x + (i * directionX), start.x  + (i * directionX)).y - end.y))){
                        return true 
                    }
                }
                return false    
