...
import { Rook } from "./figures/Rook"
    ...
    type figureNames = FigureName.QUEEN | FigureName.ROOK | FigureName.BISHOP
...
export class Cell{
        ...
        constructor(board: Board, y: number, x: number,color: Color, figure: Figure | null){
            ...
            this.cellLast = this
            this.cellVertical = this

            this.cellHorizontal = null
            this.cellFigureCurrent = null
        ...
        blockFigureMovementDiagonal(figure: Cell, king: XY){            
            ...
            let arrayFigures: Array<Cell> = [];
                if(dx !== dy){
                    return {cell: this.cellLast, bool: false}
                }
                ...
                if(arrayFigures.length === 3 && kingCell){
                    this.cellLast = arrayFigures[0]
            ...
            blockFigureMovementVertical(figure: Cell, king: XY){
                console.log(this.cellVertical, 'TRTTTydfergy');
                ...
                console.log(this.cellVertical);
    
                if(arrayCell.length === 3 && kingCell && figure.x === king.x){
                    console.log(newArray[0]);
                    
                    this.cellVertical = newArray[0]
            ...
            blockFigureMovementHorizontal(figure: Cell, king: XY){
                ...
                arrayCell.push(figure)
                console.log(arrayCell, figure.figure?.figureName);
                
                if(arrayCell.length === 3 && figure.y === king.y && arrayCell[2].figure?.figureName === FigureName.QUEEN | FigureName.ROOK |){
                    console.log(arrayCell, this.cellHorizontal);
