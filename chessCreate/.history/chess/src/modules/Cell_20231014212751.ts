...
import { Rook } from "./figures/Rook"
    ...
    export class Cell{
        ...
        Castling(clicked: Cell, current: Cell, XY: XYCastling){
            new Rook(Color.WHITE , this.board.getCell(clicked.y, XY.rookX));
            new King(Color.WHITE, this.board.getCell(current.y, XY.kingX));
            return true
        }
        clearCastling(clicked: Cell, current: Cell){
            new Rook(Color.WHITE, this.board.getCell(clicked.y, clicked.x)).cell.figure = null;
            new King(clicked.figure?.color === Color.WHITE, this.board.getCell(current.y, current.x)).cell.figure = null;
        }

        // biggerCastling(clicked: Cell, current: Cell, XY: XYCastling) {
        //     new Rook(clicked.figure?.color === Color.WHITE ? Color.WHITE : Color.BLACK, this.board.getCell(clicked.y, clicked.x)).cell.figure = null;
        //     new King(clicked.figure?.color === Color.WHITE ? Color.WHITE : Color.BLACK, this.board.getCell(current.y, current.x)).cell.figure = null;

        //     setTimeout(() => {
        //         new Rook(clicked.figure?.color === Color.WHITE ? Color.WHITE : Color.BLACK, this.board.getCell(clicked.y, XY.rookX));
        //         new King(clicked.figure?.color === Color.WHITE ? Color.WHITE : Color.BLACK, this.board.getCell(current.y, XY.kingX));
        //     }, 200)   
        // }
    }