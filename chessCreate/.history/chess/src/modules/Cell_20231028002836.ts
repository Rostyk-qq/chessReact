...
export class Cell{
        ...
        blockFigureMovementWhiteKingDiagonal(figure: Cell, king: XY){
            const dx = Math.abs(figure.x - this.x);
            const dy = Math.abs(figure.y - this.y)            
        ...
        blockFigureMovementWhiteKingVertical(figure: Cell){
            if(figure.x !== this.x){
                return false
            }

            const max = Math.max(figure.y, this.y);    
            const min = Math.min(figure.y, this.y);
        ...
        blockFigureMovementWhiteKingHorizontal(figure: Cell){
            if(figure.y !== this.y){
                return false
            }

            const max = Math.max(figure.x, this.x);    
            const min = Math.min(figure.x, this.x);
