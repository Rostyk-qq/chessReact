...
export class Cell{
        ...
        moveFigure(target: Cell){
            ...
            DiagonalKill(start: Cell, end: Cell){
                    ...
                    Math.abs(start.x - this.figure?.cellWhiteAttack.cell.x!) !== Math.abs(start.y - this.figure?.cellWhiteAttack.cell.y!)
                    ...
                    if(dx !== dy || !start.block || Math.abs(dxQueen) !== Math.abs(dyQueen)){
                        return false
                    }
