...
export class Cell{
        ...
        if(whiteFigureBlockBlackKing(figure: Cell, king: XY)){
            if(figure.figure.figureName === FigureName.QUEEN){
                if(this.blockFigureMovementWhiteKingDiagonal(figure: Cell, king: XY) ||
                this.blockFigureMovementWhiteKingVertical(figureMain.figure.cell, figureMain.king) ||
                this.blockFigureMovementWhiteKingHorizontal(figureMain.figure.cell, figureMain.king)){
                    console.log('Inside');
                    return
                }
            }
