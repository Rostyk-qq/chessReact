        ...
        moveFigure(target: Cell){
            ...
            DiagonalKill(start: Cell, end: Cell, king: XY){
                ...
                for(let i = 1; i <= dx; i++){
                    ...
                    this.board.getCell(start.y + (i * directionY), start.x  + (i * directionX)).x > king.x &&
                    
                    this.board.getCell(start.y + (i * directionY), start.x  + (i * directionX)).y < end.y &&
                    this.board.getCell(start.y + (i * directionY), start.x  + (i * directionX)).y > king.x 
                    ){
                        if(this.board.getCell(start.y + (i * directionY), start.x  + (i * directionX)).figure?.color !== start.figure?.color){
