...
export class Cell{
        ...
        blockFigureMovementWhiteKingDiagonal(figure: Cell, king: XY){
            ...
            if(dx !== dy){
                return {cell: item!, attacker: newArray[1], bool: false}
            }
            ...
            if(kingCell && newArray.length === 1){
                return {cell: newArray[0], attacker: newArray[1], bool: true}
            } 
            else{
                return {cell: newArray[0], attacker: newArray[1], bool: false}
            }
        }
