...
import { Rook } from "./figures/Rook"
    ...
    export class Cell{
        ...
        blackKingKill(cell: Cell, kingParams: XY, whiteKing: Cell | null, dxDy: XY | null){
            if(cell.figure?.figureName === FigureName.QUEEN){
                if(this.tryToKillKingHorizontal(cell, kingParams, whiteKing, dxDy) || this.tryToKillKingDiagonal(cell, kingParams, whiteKing, dxDy) || this.tryToKillKingVertical(cell, kingParams, whiteKing, dxDy)){
                    return true;
                }
            }
            if(cell.figure?.figureName === FigureName.BISHOP){
                if(this.tryToKillKingDiagonal(cell, kingParams, whiteKing, dxDy)){
                    return true
                }
            }
            if (cell.figure?.figureName === FigureName.KNIGHT) {
                if(this.tryToKillKingWithKnight(cell, kingParams, whiteKing, dxDy)){
                    return true
                }
            }
            if(cell.figure?.figureName === FigureName.PAWN){
                if(this.tryToKillKingWithPawn(cell, kingParams, whiteKing, dxDy)){
                    return true
                }
            }
            if(cell.figure?.figureName === FigureName.ROOK){
                if(this.tryToKillKingHorizontal(cell, kingParams, whiteKing, dxDy) || this.tryToKillKingVertical(cell, kingParams, whiteKing, dxDy)){
                    return true
                }
            }
        }
        
        whiteKingKill(cell: Cell, kingParams: XY, blackKing: Cell | null, dxDy: XY | null){
            if(cell.figure?.figureName === FigureName.QUEEN){
                if(this.tryToKillKingHorizontal(cell, kingParams, blackKing, dxDy) || this.tryToKillKingDiagonal(cell, kingParams, blackKing, dxDy) || this.tryToKillKingVertical(cell, kingParams, blackKing, dxDy)){
                    return true;
                }
            }
            if(cell.figure?.figureName === FigureName.BISHOP){
                if(this.tryToKillKingDiagonal(cell, kingParams, blackKing, dxDy)){
                    return true
                }
            }
            if (cell.figure?.figureName === FigureName.KNIGHT) {
                if(this.tryToKillKingWithKnight(cell, kingParams, blackKing, dxDy)){
                    return true
                }
            }
            if(cell.figure?.figureName === FigureName.PAWN){
                if(this.tryToKillKingWithPawn(cell, kingParams, blackKing, dxDy)){
                    return true
                }
            }
            if(cell.figure?.figureName === FigureName.ROOK){
                if(this.tryToKillKingHorizontal(cell, kingParams, blackKing, dxDy) || this.tryToKillKingVertical(cell, kingParams, blackKing, dxDy)){
                    return true
                }
            }
        }

        tryToKillKingDiagonal(cell: Cell, kingParams: XY, king: Cell | null, dxDy: XY | null){        
            ...
            for (let i = 1; i <= dx; i++) {
                if(!this.board.getCell(cell.y + (i * directionY), cell.x + (i * directionX)).isEmpty()){
                    if(king?.x === cell.x + (i * directionX) && king?.y === cell.y + (i * directionY)){
        ...
        tryToKillKingHorizontal(cell: Cell, kingParams: XY, king: Cell | null, dxDy: XY | null){  
        ...
        tryToKillKingVertical(cell: Cell, kingParams: XY, king: Cell | null, dxDy: XY | null){  
        ...
        tryToKillKingWithKnight(cell: Cell, kingParams: XY, king: Cell | null, dxDy: XY | null){ 
            const dx = Math.abs(cell.x - kingParams.x);
            const dy = Math.abs(cell.y - kingParams.y);
        ...
        tryToKillKingWithPawn(cell: Cell, kingParams: XY, king: Cell | null){
        ...
        clearToCastling(clickedCell: Cell, currentCell: Cell, dxDy: XY | null){
