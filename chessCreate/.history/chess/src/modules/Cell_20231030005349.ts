...
export class Cell{
        ...
        blockFigureMovementDiagonalBlackKing(figure: Cell, king: XY){
            ...
            const newArray = arrayFigures.filter(cell => cell.figure?.figureName !== FigureName.KING)
            
            if(kingCell && newArray.length === 1){
        ...
        blockFigureMovementVerticalBlackKing(figure: Cell, king: XY){
            let item: Cell;
        ...
        blockFigureMovementHorizontalBlackKing(figure: Cell, king: XY){
            let item: Cell;
            const arrayCell: Array<Cell> = [];
            ...
            if(figure.x < 5 && (figure.figure?.figureName === FigureName.QUEEN || figure.figure?.figureName === FigureName.ROOK) ){
                console.log(figure.x + '< 5');
            ...
            if(figure.x > 4 && (figure.figure?.figureName === FigureName.QUEEN || figure.figure?.figureName === FigureName.ROOK){
                console.log(figure.x + '> 4');
        ...
        blockFigureMovementDiagonalWhiteKing(figure: Cell, king: XY){
            const dx = Math.abs(figure.x - king.x);
            const dy = Math.abs(figure.y - king.y);
        ...
        blockFigureMovementVerticalWhiteKing(figure: Cell, king: XY){
            let item: Cell;
            const arrayCell: Array<Cell> = [];
        ...
        blockFigureMovementHorizontalWhiteKing(figure: Cell, king: XY){
            let item: Cell;
            const arrayCell: Array<Cell> = [];
