...
export class Cell{
        ...
        blockFigureMovementVertical(figure: Cell, king: XY){
            ...
            // if(figure.x !== king.x || arrayCell.length !== 2){
            //     return {cell: arrayCell[0], bool: false}
            // }
            // if(arrayCell.length === 2){
            //     return {cell: arrayCell[0], bool: true}
            // } 
        }
        ...
        blockFigureMovementHorizontal(figure: Cell, king: XY){
            ...
            if(arrayCell.length === 2 && kingCell){
                console.log({cell: arrayCell[0], bool: true });
                return {cell: newArray[0], bool: true}
            } 
            if(figure.y !== king.y || arrayCell.length !== 2){
                console.log({cell: arrayCell[0], bool: false});
                return {cell: newArray[0], bool: false}
            } 
        }
