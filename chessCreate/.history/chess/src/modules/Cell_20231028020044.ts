...
export class Cell{
        ...
        whiteFigureBlockBlackKing(figure: Cell, king: XY){
            ...
            if(figure.figure?.figureName === FigureName.BISHOP){
                if(this.blockFigureMovementWhiteKingDiagonal(figure, king)){
                    const res: Cell = this.blockFigureMovementWhiteKingDiagonal(figure, king)!
        ...
        blockFigureMovementWhiteKingDiagonal(figure: Cell, king: XY){
            ...
            for (let i = 1; i < dy; i++) {
                if(!this.board.getCell(figure.y + (i * directionY), figure.x + (i * directionX)).isEmpty()){
                    if(this.board.getCell(figure.y + (i * directionY), figure.x + (i * directionX)).figure?.figureName !== FigureName.KING 
                    || this.board.getCell(figure.y + (i * directionY), figure.x + (i * directionX)).figure?.color === Color.BLACK){
                        a = a + 1
